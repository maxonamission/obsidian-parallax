...
var en = {
  ...
  interview: {
    opening: "Opening",
    probes: "Probes:",
    sourceSubquestion: "sub-question",
    sourceGap: "evidence gap",
    sourceAssumption: "assumption",
    sourceBelief: "belief",
    sourceOther: "other",
    exportDateLine: "Date:",
    exportRespondentLine: "Respondent:",
    exportClosing: "After the interview: save the transcript as a markdown file in the Quadro starter kit's Data/ folder (tip: Voxtral Transcribe turns the recording into a transcript)."
  },
  connections: {
    parent: "Parent session",
    followUps: "Follow-up sessions",
    hub: "Project hub",
    sharedSources: "shares {n} source(s)",
    more: "\u2026 and {n} more"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "Qualitative analysis (Quadro)",
    qdaSourceLine: "Read from {root} on {date}.",
    qdaCodesLine: "Codebook: {total} codes ({groups} groups); {created} created, {assigned} assignments to existing codes.",
    qdaSaturationLine: "Saturation signal (codes): {created} new against {assigned} assignments (ratio {ratio}).",
    qdaExtractionsLine: "Extractions: {types} type(s); {created} created, {added} paragraphs added.",
    qdaDataLine: "Data files marked as read: {n}.",
    qdaPeriodLine: "Recorded activity from {first} to {last}."
  },
  quadro: {
    codebookGroup: "theoretical lenses",
    codeDescription: "{why} It would predict: {predicts}",
    codeDescriptionLensOnly: "Theoretical lens: {name}.",
    kitReadmeTitle: "Quadro starter kit",
    kitReadmeIntro: "Generated by Parallax from {source} on {date}. Copy the folders Data, Codes and Extractions into the root of your Quadro vault (or merge them into the folders configured in Quadro's settings).",
    kitCodesLine: "Codes/ \u2014 a starting codebook derived from the adopted theoretical lenses: an a-priori (deductive) set to code with, next to the codes that emerge from your data.",
    kitExtractionsLine: "Extractions/ \u2014 one extraction type per research question; each Template.md pre-fills the extraction form Quadro shows.",
  ...
  logbook: {
    ...
    stepLibrary: "Library",
    libraryUpdated: "{n} reference(s) updated from the .bib library",
    stepAccount: "Account",
    ...
    argumentAdopted: "{n} element(s) adopted in the argument map",
...
var nl = {
  ...
  interview: {
    opening: "Opening",
    probes: "Doorvragen:",
    sourceSubquestion: "deelvraag",
    sourceGap: "kennisgat",
    sourceAssumption: "aanname",
    sourceBelief: "overtuiging",
    sourceOther: "overig",
    exportDateLine: "Datum:",
    exportRespondentLine: "Respondent:",
    exportClosing: "Na het interview: zet het transcript als markdown-bestand in de map Data/ van de Quadro-starterkit (tip: Voxtral Transcribe zet de opname om naar een transcript)."
  },
  connections: {
    parent: "Ouder-sessie",
    followUps: "Vervolgsessies",
    hub: "Projecthub",
    sharedSources: "deelt {n} bron(nen)",
    more: "\u2026 en {n} meer"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "Kwalitatieve analyse (Quadro)",
    qdaSourceLine: "Gelezen uit {root} op {date}.",
    qdaCodesLine: "Codeboek: {total} codes ({groups} groepen); {created} aangemaakt, {assigned} toewijzingen aan bestaande codes.",
    qdaSaturationLine: "Saturatiesignaal (codes): {created} nieuw tegenover {assigned} toewijzingen (ratio {ratio}).",
    qdaExtractionsLine: "Extracties: {types} type(s); {created} aangemaakt, {added} alinea's toegevoegd.",
    qdaDataLine: "Databestanden als gelezen gemarkeerd: {n}.",
    qdaPeriodLine: "Geregistreerde activiteit van {first} tot {last}."
  },
  quadro: {
    codebookGroup: "theoretische lenzen",
    codeDescription: "{why} Het zou voorspellen: {predicts}",
    codeDescriptionLensOnly: "Theoretische lens: {name}.",
    kitReadmeTitle: "Quadro-starterkit",
    kitReadmeIntro: "Gegenereerd door Parallax uit {source} op {date}. Kopieer de mappen Data, Codes en Extractions naar de root van je Quadro-vault (of voeg ze samen met de mappen die in Quadro's instellingen zijn geconfigureerd).",
    kitCodesLine: "Codes/ \u2014 een startcodeboek afgeleid uit de gekozen theoretische lenzen: een a-priori (deductieve) set om mee te coderen, naast de codes die uit je data opkomen.",
    kitExtractionsLine: "Extractions/ \u2014 \xE9\xE9n extractietype per onderzoeksvraag; elke Template.md vult het extractieformulier van Quadro voor.",
  ...
  logbook: {
    ...
    libraryUpdated: "{n} referentie(s) bijgewerkt uit de .bib-bibliotheek",
    ...
    stepArgument: "Argument",
    argumentAdopted: "{n} element(en) geadopteerd in de argumentkaart",
    stepConnections: "Verbanden",
...
var fr = {
  ...
  interview: {
    opening: "Ouverture",
    probes: "Relances :",
    sourceSubquestion: "sous-question",
    sourceGap: "lacune de preuves",
    sourceAssumption: "pr\xE9suppos\xE9",
    sourceBelief: "conviction",
    sourceOther: "autre",
    exportDateLine: "Date :",
    exportRespondentLine: "R\xE9pondant :",
    exportClosing: "Apr\xE8s l'entretien : placez la transcription en fichier markdown dans le dossier Data/ du kit de d\xE9marrage Quadro (astuce : Voxtral Transcribe transforme l'enregistrement en transcription)."
  },
  connections: {
    parent: "Session parente",
    followUps: "Sessions de suivi",
    hub: "Hub du projet",
    sharedSources: "partage {n} source(s)",
    more: "\u2026 et {n} de plus"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "Analyse qualitative (Quadro)",
    qdaSourceLine: "Lu depuis {root} le {date}.",
    qdaCodesLine: "Livre de codes : {total} codes ({groups} groupes) ; {created} cr\xE9\xE9s, {assigned} attributions \xE0 des codes existants.",
    qdaSaturationLine: "Signal de saturation (codes) : {created} nouveaux contre {assigned} attributions (ratio {ratio}).",
    qdaExtractionsLine: "Extractions : {types} type(s) ; {created} cr\xE9\xE9es, {added} paragraphes ajout\xE9s.",
    qdaDataLine: "Fichiers de donn\xE9es marqu\xE9s comme lus : {n}.",
    qdaPeriodLine: "Activit\xE9 enregistr\xE9e du {first} au {last}."
  },
  quadro: {
    codebookGroup: "lentilles th\xE9oriques",
    codeDescription: "{why} Elle pr\xE9dirait : {predicts}",
    codeDescriptionLensOnly: "Lentille th\xE9orique : {name}.",
    kitReadmeTitle: "Kit de d\xE9marrage Quadro",
    kitReadmeIntro: "G\xE9n\xE9r\xE9 par Parallax \xE0 partir de {source} le {date}. Copiez les dossiers Data, Codes et Extractions \xE0 la racine de votre coffre Quadro (ou fusionnez-les avec les dossiers configur\xE9s dans les r\xE9glages de Quadro).",
    kitCodesLine: "Codes/ \u2014 un livre de codes de d\xE9part d\xE9riv\xE9 des lentilles th\xE9oriques retenues : un ensemble a priori (d\xE9ductif) pour coder, \xE0 c\xF4t\xE9 des codes qui \xE9mergent de vos donn\xE9es.",
    kitExtractionsLine: "Extractions/ \u2014 un type d'extraction par question de recherche ; chaque Template.md pr\xE9-remplit le formulaire d'extraction affich\xE9 par Quadro.",
  ...
  logbook: {
    ...
    libraryUpdated: "{n} r\xE9f\xE9rence(s) mise(s) \xE0 jour depuis la biblioth\xE8que .bib",
    ...
    stepArgument: "Argument",
    argumentAdopted: "{n} \xE9l\xE9ment(s) adopt\xE9(s) dans la carte argumentative",
    stepConnections: "Connexions",
...
var de = {
  ...
  interview: {
    opening: "Einstieg",
    probes: "Nachfragen:",
    sourceSubquestion: "Teilfrage",
    sourceGap: "Wissensl\xFCcke",
    sourceAssumption: "Annahme",
    sourceBelief: "\xDCberzeugung",
    sourceOther: "Sonstiges",
    exportDateLine: "Datum:",
    exportRespondentLine: "Befragte(r):",
    exportClosing: "Nach dem Interview: Legen Sie das Transkript als Markdown-Datei im Ordner Data/ des Quadro-Starterkits ab (Tipp: Voxtral Transcribe wandelt die Aufnahme in ein Transkript um)."
  },
  connections: {
    parent: "\xDCbergeordnete Session",
    followUps: "Folgesessions",
    hub: "Projekt-Hub",
    sharedSources: "teilt {n} Quelle(n)",
    more: "\u2026 und {n} weitere"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "Qualitative Analyse (Quadro)",
    qdaSourceLine: "Gelesen aus {root} am {date}.",
    qdaCodesLine: "Codebuch: {total} Codes ({groups} Gruppen); {created} erstellt, {assigned} Zuordnungen zu bestehenden Codes.",
    qdaSaturationLine: "S\xE4ttigungssignal (Codes): {created} neue gegen\xFCber {assigned} Zuordnungen (Verh\xE4ltnis {ratio}).",
    qdaExtractionsLine: "Extraktionen: {types} Typ(en); {created} erstellt, {added} Abs\xE4tze hinzugef\xFCgt.",
    qdaDataLine: "Als gelesen markierte Datendateien: {n}.",
    qdaPeriodLine: "Erfasste Aktivit\xE4t von {first} bis {last}."
  },
  quadro: {
    codebookGroup: "theoretische Linsen",
    codeDescription: "{why} Sie w\xFCrde vorhersagen: {predicts}",
    codeDescriptionLensOnly: "Theoretische Linse: {name}.",
    kitReadmeTitle: "Quadro-Starterkit",
    kitReadmeIntro: "Erstellt von Parallax aus {source} am {date}. Kopiere die Ordner Data, Codes und Extractions in das Stammverzeichnis deines Quadro-Vaults (oder f\xFChre sie mit den in Quadros Einstellungen konfigurierten Ordnern zusammen).",
    kitCodesLine: "Codes/ \u2014 ein Start-Codebuch, abgeleitet aus den gew\xE4hlten theoretischen Linsen: ein A-priori-Set (deduktiv) zum Codieren, neben den Codes, die aus deinen Daten hervorgehen.",
    kitExtractionsLine: "Extractions/ \u2014 ein Extraktionstyp pro Forschungsfrage; jede Template.md f\xFCllt das Extraktionsformular vor, das Quadro anzeigt.",
  ...
  logbook: {
    ...
    libraryUpdated: "{n} Referenz(en) aus der .bib-Bibliothek aktualisiert",
    ...
    stepArgument: "Argument",
    argumentAdopted: "{n} Element(e) in die Argumentkarte \xFCbernommen",
    stepConnections: "Verbindungen",
...
var es = {
  ...
  interview: {
    opening: "Apertura",
    probes: "Preguntas de sondeo:",
    sourceSubquestion: "subpregunta",
    sourceGap: "laguna de evidencia",
    sourceAssumption: "supuesto",
    sourceBelief: "convicci\xF3n",
    sourceOther: "otro",
    exportDateLine: "Fecha:",
    exportRespondentLine: "Entrevistado/a:",
    exportClosing: "Despu\xE9s de la entrevista: guarde la transcripci\xF3n como archivo markdown en la carpeta Data/ del kit de inicio de Quadro (consejo: Voxtral Transcribe convierte la grabaci\xF3n en una transcripci\xF3n)."
  },
  connections: {
    parent: "Sesi\xF3n de origen",
    followUps: "Sesiones de seguimiento",
    hub: "Hub del proyecto",
    sharedSources: "comparte {n} fuente(s)",
    more: "\u2026 y {n} m\xE1s"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "An\xE1lisis cualitativo (Quadro)",
    qdaSourceLine: "Le\xEDdo desde {root} el {date}.",
    qdaCodesLine: "Libro de c\xF3digos: {total} c\xF3digos ({groups} grupos); {created} creados, {assigned} asignaciones a c\xF3digos existentes.",
    qdaSaturationLine: "Se\xF1al de saturaci\xF3n (c\xF3digos): {created} nuevos frente a {assigned} asignaciones (proporci\xF3n {ratio}).",
    qdaExtractionsLine: "Extracciones: {types} tipo(s); {created} creadas, {added} p\xE1rrafos a\xF1adidos.",
    qdaDataLine: "Archivos de datos marcados como le\xEDdos: {n}.",
    qdaPeriodLine: "Actividad registrada de {first} a {last}."
  },
  quadro: {
    codebookGroup: "lentes te\xF3ricas",
    codeDescription: "{why} Predecir\xEDa: {predicts}",
    codeDescriptionLensOnly: "Lente te\xF3rica: {name}.",
    kitReadmeTitle: "Kit de inicio de Quadro",
    kitReadmeIntro: "Generado por Parallax a partir de {source} el {date}. Copia las carpetas Data, Codes y Extractions a la ra\xEDz de tu b\xF3veda de Quadro (o fusi\xF3nalas con las carpetas configuradas en los ajustes de Quadro).",
    kitCodesLine: "Codes/ \u2014 un libro de c\xF3digos inicial derivado de las lentes te\xF3ricas adoptadas: un conjunto a priori (deductivo) con el que codificar, junto a los c\xF3digos que emergen de tus datos.",
    kitExtractionsLine: "Extractions/ \u2014 un tipo de extracci\xF3n por pregunta de investigaci\xF3n; cada Template.md rellena previamente el formulario de extracci\xF3n que muestra Quadro.",
  ...
  logbook: {
    ...
    libraryUpdated: "{n} referencia(s) actualizada(s) desde la biblioteca .bib",
    ...
    stepArgument: "Argumento",
    argumentAdopted: "{n} elemento(s) adoptado(s) en el mapa argumentativo",
    stepConnections: "Conexiones",
...
var pt = {
  ...
  interview: {
    ...
    sourceSubquestion: "subquest\xE3o",
    sourceGap: "lacuna de evid\xEAncia",
    sourceAssumption: "pressuposto",
    sourceBelief: "convic\xE7\xE3o",
    sourceOther: "outro",
    exportDateLine: "Data:",
    exportRespondentLine: "Entrevistado/a:",
    exportClosing: "Ap\xF3s a entrevista: guarde a transcri\xE7\xE3o como ficheiro markdown na pasta Data/ do kit inicial do Quadro (dica: o Voxtral Transcribe converte a grava\xE7\xE3o numa transcri\xE7\xE3o)."
  },
  connections: {
    parent: "Sess\xE3o de origem",
    followUps: "Sess\xF5es de seguimento",
    hub: "Hub do projeto",
    sharedSources: "partilha {n} fonte(s)",
    more: "\u2026 e mais {n}"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "An\xE1lise qualitativa (Quadro)",
    qdaSourceLine: "Lido de {root} em {date}.",
    qdaCodesLine: "Livro de c\xF3digos: {total} c\xF3digos ({groups} grupos); {created} criados, {assigned} atribui\xE7\xF5es a c\xF3digos existentes.",
    qdaSaturationLine: "Sinal de satura\xE7\xE3o (c\xF3digos): {created} novos face a {assigned} atribui\xE7\xF5es (r\xE1cio {ratio}).",
    qdaExtractionsLine: "Extra\xE7\xF5es: {types} tipo(s); {created} criadas, {added} par\xE1grafos adicionados.",
    qdaDataLine: "Ficheiros de dados marcados como lidos: {n}.",
    qdaPeriodLine: "Atividade registada de {first} a {last}."
  },
  quadro: {
    codebookGroup: "lentes te\xF3ricas",
    codeDescription: "{why} Preveria: {predicts}",
    codeDescriptionLensOnly: "Lente te\xF3rica: {name}.",
    kitReadmeTitle: "Kit inicial do Quadro",
    kitReadmeIntro: "Gerado pelo Parallax a partir de {source} em {date}. Copie as pastas Data, Codes e Extractions para a raiz do seu vault do Quadro (ou junte-as \xE0s pastas configuradas nas defini\xE7\xF5es do Quadro).",
    kitCodesLine: "Codes/ \u2014 um livro de c\xF3digos inicial derivado das lentes te\xF3ricas adotadas: um conjunto a priori (dedutivo) para codificar, ao lado dos c\xF3digos que emergem dos seus dados.",
    kitExtractionsLine: "Extractions/ \u2014 um tipo de extra\xE7\xE3o por quest\xE3o de pesquisa; cada Template.md pr\xE9-preenche o formul\xE1rio de extra\xE7\xE3o que o Quadro apresenta.",
  ...
  logbook: {
    ...
    stepLibrary: "Biblioteca",
    libraryUpdated: "{n} refer\xEAncia(s) atualizada(s) a partir da biblioteca .bib",
    stepAccount: "Relato",
    ...
    stepArgument: "Argumento",
    argumentAdopted: "{n} elemento(s) adotado(s) no mapa argumentativo",
    stepConnections: "Conex\xF5es",
...
var it = {
  ...
  interview: {
    opening: "Apertura",
    probes: "Domande di approfondimento:",
    sourceSubquestion: "sottodomanda",
    sourceGap: "lacuna di evidenza",
    sourceAssumption: "assunto",
    sourceBelief: "convinzione",
    sourceOther: "altro",
    exportDateLine: "Data:",
    exportRespondentLine: "Intervistato/a:",
    exportClosing: "Dopo l'intervista: salva la trascrizione come file markdown nella cartella Data/ dello starter kit di Quadro (suggerimento: Voxtral Transcribe trasforma la registrazione in una trascrizione)."
  },
  connections: {
    parent: "Sessione di origine",
    followUps: "Sessioni di seguito",
    hub: "Hub del progetto",
    sharedSources: "condivide {n} fonte/i",
    more: "\u2026 e altri {n}"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "Analisi qualitativa (Quadro)",
    qdaSourceLine: "Letto da {root} il {date}.",
    qdaCodesLine: "Libro dei codici: {total} codici ({groups} gruppi); {created} creati, {assigned} assegnazioni a codici esistenti.",
    qdaSaturationLine: "Segnale di saturazione (codici): {created} nuovi contro {assigned} assegnazioni (rapporto {ratio}).",
    qdaExtractionsLine: "Estrazioni: {types} tipo(i); {created} create, {added} paragrafi aggiunti.",
    qdaDataLine: "File di dati contrassegnati come letti: {n}.",
    qdaPeriodLine: "Attivit\xE0 registrata dal {first} al {last}."
  },
  quadro: {
    codebookGroup: "lenti teoriche",
    codeDescription: "{why} Prevederebbe: {predicts}",
    codeDescriptionLensOnly: "Lente teorica: {name}.",
    kitReadmeTitle: "Kit di partenza di Quadro",
    kitReadmeIntro: "Generato da Parallax a partire da {source} il {date}. Copia le cartelle Data, Codes ed Extractions nella radice del tuo vault di Quadro (oppure uniscile alle cartelle configurate nelle impostazioni di Quadro).",
    kitCodesLine: "Codes/ \u2014 un libro dei codici di partenza derivato dalle lenti teoriche adottate: un insieme a priori (deduttivo) con cui codificare, accanto ai codici che emergono dai tuoi dati.",
    kitExtractionsLine: "Extractions/ \u2014 un tipo di estrazione per ogni domanda di ricerca; ogni Template.md precompila il modulo di estrazione mostrato da Quadro.",
  ...
  logbook: {
    ...
    stepLibrary: "Biblioteca",
    libraryUpdated: "{n} riferimento/i aggiornato/i dalla biblioteca .bib",
    ...
    stepArgument: "Argomento",
    argumentAdopted: "{n} elemento/i adottato/i nella mappa argomentativa",
    stepConnections: "Connessioni",
...
var ru = {
  ...
  interview: {
    opening: "\u0412\u0441\u0442\u0443\u043F\u043B\u0435\u043D\u0438\u0435",
    probes: "\u0423\u0442\u043E\u0447\u043D\u044F\u044E\u0449\u0438\u0435 \u0432\u043E\u043F\u0440\u043E\u0441\u044B:",
    sourceSubquestion: "\u043F\u043E\u0434\u0432\u043E\u043F\u0440\u043E\u0441",
    sourceGap: "\u043F\u0440\u043E\u0431\u0435\u043B \u0432 \u0434\u0430\u043D\u043D\u044B\u0445",
    sourceAssumption: "\u0434\u043E\u043F\u0443\u0449\u0435\u043D\u0438\u0435",
    sourceBelief: "\u0443\u0431\u0435\u0436\u0434\u0435\u043D\u0438\u0435",
    sourceOther: "\u0434\u0440\u0443\u0433\u043E\u0435",
    exportDateLine: "\u0414\u0430\u0442\u0430:",
    exportRespondentLine: "\u0420\u0435\u0441\u043F\u043E\u043D\u0434\u0435\u043D\u0442:",
    exportClosing: "\u041F\u043E\u0441\u043B\u0435 \u0438\u043D\u0442\u0435\u0440\u0432\u044C\u044E: \u0441\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u0435 \u0442\u0440\u0430\u043D\u0441\u043A\u0440\u0438\u043F\u0442 \u043A\u0430\u043A markdown-\u0444\u0430\u0439\u043B \u0432 \u043F\u0430\u043F\u043A\u0435 Data/ \u0441\u0442\u0430\u0440\u0442\u043E\u0432\u043E\u0433\u043E \u043D\u0430\u0431\u043E\u0440\u0430 Quadro (\u0441\u043E\u0432\u0435\u0442: Voxtral Transcribe \u043F\u0440\u0435\u0432\u0440\u0430\u0449\u0430\u0435\u0442 \u0437\u0430\u043F\u0438\u0441\u044C \u0432 \u0442\u0440\u0430\u043D\u0441\u043A\u0440\u0438\u043F\u0442)."
  },
  connections: {
    parent: "\u0420\u043E\u0434\u0438\u0442\u0435\u043B\u044C\u0441\u043A\u0430\u044F \u0441\u0435\u0441\u0441\u0438\u044F",
    followUps: "\u041F\u043E\u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0438\u0435 \u0441\u0435\u0441\u0441\u0438\u0438",
    hub: "\u0425\u0430\u0431 \u043F\u0440\u043E\u0435\u043A\u0442\u0430",
    sharedSources: "\u043E\u0431\u0449\u0438\u0445 \u0438\u0441\u0442\u043E\u0447\u043D\u0438\u043A\u043E\u0432: {n}",
    more: "\u2026 \u0438 \u0435\u0449\u0451 {n}"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "\u041A\u0430\u0447\u0435\u0441\u0442\u0432\u0435\u043D\u043D\u044B\u0439 \u0430\u043D\u0430\u043B\u0438\u0437 (Quadro)",
    qdaSourceLine: "\u041F\u0440\u043E\u0447\u0438\u0442\u0430\u043D\u043E \u0438\u0437 {root} {date}.",
    qdaCodesLine: "\u041A\u043E\u0434\u043E\u0432\u0430\u044F \u043A\u043D\u0438\u0433\u0430: {total} \u043A\u043E\u0434\u043E\u0432 ({groups} \u0433\u0440\u0443\u043F\u043F); {created} \u0441\u043E\u0437\u0434\u0430\u043D\u043E, {assigned} \u043F\u0440\u0438\u0441\u0432\u043E\u0435\u043D\u0438\u0439 \u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0443\u044E\u0449\u0438\u043C \u043A\u043E\u0434\u0430\u043C.",
    qdaSaturationLine: "\u0421\u0438\u0433\u043D\u0430\u043B \u043D\u0430\u0441\u044B\u0449\u0435\u043D\u0438\u044F (\u043A\u043E\u0434\u044B): {created} \u043D\u043E\u0432\u044B\u0445 \u043F\u0440\u043E\u0442\u0438\u0432 {assigned} \u043F\u0440\u0438\u0441\u0432\u043E\u0435\u043D\u0438\u0439 (\u0441\u043E\u043E\u0442\u043D\u043E\u0448\u0435\u043D\u0438\u0435 {ratio}).",
    qdaExtractionsLine: "\u0418\u0437\u0432\u043B\u0435\u0447\u0435\u043D\u0438\u044F: {types} \u0442\u0438\u043F(\u043E\u0432); {created} \u0441\u043E\u0437\u0434\u0430\u043D\u043E, {added} \u0430\u0431\u0437\u0430\u0446\u0435\u0432 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u043E.",
    qdaDataLine: "\u0424\u0430\u0439\u043B\u043E\u0432 \u0434\u0430\u043D\u043D\u044B\u0445 \u043E\u0442\u043C\u0435\u0447\u0435\u043D\u043E \u043A\u0430\u043A \u043F\u0440\u043E\u0447\u0438\u0442\u0430\u043D\u043D\u044B\u0435: {n}.",
    qdaPeriodLine: "\u0417\u0430\u0444\u0438\u043A\u0441\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u0430\u044F \u0430\u043A\u0442\u0438\u0432\u043D\u043E\u0441\u0442\u044C \u0441 {first} \u043F\u043E {last}."
  },
  quadro: {
    codebookGroup: "\u0442\u0435\u043E\u0440\u0435\u0442\u0438\u0447\u0435\u0441\u043A\u0438\u0435 \u043B\u0438\u043D\u0437\u044B",
    codeDescription: "{why} \u041E\u043D\u0430 \u043F\u0440\u0435\u0434\u0441\u043A\u0430\u0437\u044B\u0432\u0430\u043B\u0430 \u0431\u044B: {predicts}",
    codeDescriptionLensOnly: "\u0422\u0435\u043E\u0440\u0435\u0442\u0438\u0447\u0435\u0441\u043A\u0430\u044F \u043B\u0438\u043D\u0437\u0430: {name}.",
    kitReadmeTitle: "\u0421\u0442\u0430\u0440\u0442\u043E\u0432\u044B\u0439 \u043D\u0430\u0431\u043E\u0440 Quadro",
    kitReadmeIntro: "\u0421\u0433\u0435\u043D\u0435\u0440\u0438\u0440\u043E\u0432\u0430\u043D\u043E Parallax \u0438\u0437 {source} {date}. \u0421\u043A\u043E\u043F\u0438\u0440\u0443\u0439\u0442\u0435 \u043F\u0430\u043F\u043A\u0438 Data, Codes \u0438 Extractions \u0432 \u043A\u043E\u0440\u0435\u043D\u044C \u0432\u0430\u0448\u0435\u0433\u043E \u0445\u0440\u0430\u043D\u0438\u043B\u0438\u0449\u0430 Quadro (\u0438\u043B\u0438 \u043E\u0431\u044A\u0435\u0434\u0438\u043D\u0438\u0442\u0435 \u0438\u0445 \u0441 \u043F\u0430\u043F\u043A\u0430\u043C\u0438, \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043D\u043D\u044B\u043C\u0438 \u0432 \u043F\u0430\u0440\u0430\u043C\u0435\u0442\u0440\u0430\u0445 Quadro).",
    kitCodesLine: "Codes/ \u2014 \u0441\u0442\u0430\u0440\u0442\u043E\u0432\u0430\u044F \u043A\u043E\u0434\u043E\u0432\u0430\u044F \u043A\u043D\u0438\u0433\u0430, \u0432\u044B\u0432\u0435\u0434\u0435\u043D\u043D\u0430\u044F \u0438\u0437 \u043F\u0440\u0438\u043D\u044F\u0442\u044B\u0445 \u0442\u0435\u043E\u0440\u0435\u0442\u0438\u0447\u0435\u0441\u043A\u0438\u0445 \u043B\u0438\u043D\u0437: \u0430\u043F\u0440\u0438\u043E\u0440\u043D\u044B\u0439 (\u0434\u0435\u0434\u0443\u043A\u0442\u0438\u0432\u043D\u044B\u0439) \u043D\u0430\u0431\u043E\u0440 \u0434\u043B\u044F \u043A\u043E\u0434\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F, \u043D\u0430\u0440\u044F\u0434\u0443 \u0441 \u043A\u043E\u0434\u0430\u043C\u0438, \u0432\u043E\u0437\u043D\u0438\u043A\u0430\u044E\u0449\u0438\u043C\u0438 \u0438\u0437 \u0432\u0430\u0448\u0438\u0445 \u0434\u0430\u043D\u043D\u044B\u0445.",
    kitExtractionsLine: "Extractions/ \u2014 \u043E\u0434\u0438\u043D \u0442\u0438\u043F \u0438\u0437\u0432\u043B\u0435\u0447\u0435\u043D\u0438\u044F \u043D\u0430 \u043A\u0430\u0436\u0434\u044B\u0439 \u0438\u0441\u0441\u043B\u0435\u0434\u043E\u0432\u0430\u0442\u0435\u043B\u044C\u0441\u043A\u0438\u0439 \u0432\u043E\u043F\u0440\u043E\u0441; \u043A\u0430\u0436\u0434\u044B\u0439 Template.md \u043F\u0440\u0435\u0434\u0437\u0430\u043F\u043E\u043B\u043D\u044F\u0435\u0442 \u0444\u043E\u0440\u043C\u0443 \u0438\u0437\u0432\u043B\u0435\u0447\u0435\u043D\u0438\u044F, \u043A\u043E\u0442\u043E\u0440\u0443\u044E \u043F\u043E\u043A\u0430\u0437\u044B\u0432\u0430\u0435\u0442 Quadro.",
  ...
  logbook: {
    ...
    libraryUpdated: "{n} \u0441\u0441\u044B\u043B\u043A\u0430(\u0438) \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430(\u044B) \u0438\u0437 \u0431\u0438\u0431\u043B\u0438\u043E\u0442\u0435\u043A\u0438 .bib",
    ...
    stepArgument: "\u0410\u0440\u0433\u0443\u043C\u0435\u043D\u0442",
    argumentAdopted: "\u043F\u0440\u0438\u043D\u044F\u0442\u043E \u044D\u043B\u0435\u043C\u0435\u043D\u0442\u043E\u0432 \u0432 \u043A\u0430\u0440\u0442\u0443 \u0430\u0440\u0433\u0443\u043C\u0435\u043D\u0442\u0430\u0446\u0438\u0438: {n}",
    stepConnections: "\u0421\u0432\u044F\u0437\u0438",
...
var zh = {
  ...
  interview: {
    opening: "\u5F00\u573A",
    probes: "\u8FFD\u95EE\uFF1A",
    sourceSubquestion: "\u5B50\u95EE\u9898",
    sourceGap: "\u8BC1\u636E\u7F3A\u53E3",
    sourceAssumption: "\u5047\u8BBE",
    sourceBelief: "\u4FE1\u5FF5",
    sourceOther: "\u5176\u4ED6",
    exportDateLine: "\u65E5\u671F\uFF1A",
    exportRespondentLine: "\u53D7\u8BBF\u8005\uFF1A",
    exportClosing: "\u8BBF\u8C08\u7ED3\u675F\u540E\uFF1A\u5C06\u8F6C\u5F55\u6587\u672C\u4EE5 markdown \u6587\u4EF6\u5F62\u5F0F\u653E\u5165 Quadro \u5165\u95E8\u5957\u4EF6\u7684 Data/ \u6587\u4EF6\u5939\uFF08\u63D0\u793A\uFF1AVoxtral Transcribe \u53EF\u5C06\u5F55\u97F3\u8F6C\u6210\u8F6C\u5F55\u6587\u672C\uFF09\u3002"
  },
  connections: {
    parent: "\u7236\u4F1A\u8BDD",
    followUps: "\u540E\u7EED\u4F1A\u8BDD",
    hub: "\u9879\u76EE\u67A2\u7EBD",
    sharedSources: "\u5171\u4EAB {n} \u4E2A\u6765\u6E90",
    more: "\u2026\u2026\u53E6\u6709 {n} \u4E2A"
  },
  beliefs: {
    none: "_\uFF08\u5C1A\u672A\u8BB0\u5F55\u4EFB\u4F55\u4FE1\u5FF5\uFF09_",
  ...
  account: {
    ...
    qdaHeading: "\u5B9A\u6027\u5206\u6790\uFF08Quadro\uFF09",
    qdaSourceLine: "\u4E8E {date} \u4ECE {root} \u8BFB\u53D6\u3002",
    qdaCodesLine: "\u7801\u672C\uFF1A{total} \u4E2A\u4EE3\u7801\uFF08{groups} \u4E2A\u5206\u7EC4\uFF09\uFF1B\u65B0\u5EFA {created} \u4E2A\uFF0C\u5411\u73B0\u6709\u4EE3\u7801\u5206\u914D {assigned} \u6B21\u3002",
    qdaSaturationLine: "\u9971\u548C\u4FE1\u53F7\uFF08\u4EE3\u7801\uFF09\uFF1A{created} \u4E2A\u65B0\u4EE3\u7801\u5BF9 {assigned} \u6B21\u5206\u914D\uFF08\u6BD4\u7387 {ratio}\uFF09\u3002",
    qdaExtractionsLine: "\u63D0\u53D6\uFF1A{types} \u79CD\u7C7B\u578B\uFF1B\u65B0\u5EFA {created} \u4E2A\uFF0C\u6DFB\u52A0 {added} \u4E2A\u6BB5\u843D\u3002",
    qdaDataLine: "\u6807\u8BB0\u4E3A\u5DF2\u8BFB\u7684\u6570\u636E\u6587\u4EF6\uFF1A{n} \u4E2A\u3002",
    qdaPeriodLine: "\u8BB0\u5F55\u7684\u6D3B\u52A8\u65F6\u95F4\u4ECE {first} \u81F3 {last}\u3002"
  },
  quadro: {
    codebookGroup: "\u7406\u8BBA\u89C6\u89D2",
    codeDescription: "{why} \u5B83\u4F1A\u9884\u6D4B\uFF1A{predicts}",
    codeDescriptionLensOnly: "\u7406\u8BBA\u89C6\u89D2\uFF1A{name}\u3002",
    kitReadmeTitle: "Quadro \u5165\u95E8\u5957\u4EF6",
    kitReadmeIntro: "\u7531 Parallax \u4E8E {date} \u4ECE {source} \u751F\u6210\u3002\u8BF7\u5C06 Data\u3001Codes \u548C Extractions \u8FD9\u51E0\u4E2A\u6587\u4EF6\u5939\u590D\u5236\u5230\u4F60\u7684 Quadro \u4ED3\u5E93\u6839\u76EE\u5F55\uFF08\u6216\u5C06\u5176\u5408\u5E76\u5230 Quadro \u8BBE\u7F6E\u4E2D\u914D\u7F6E\u7684\u6587\u4EF6\u5939\uFF09\u3002",
    kitCodesLine: "Codes/ \u2014\u2014 \u7531\u6240\u91C7\u7EB3\u7684\u7406\u8BBA\u89C6\u89D2\u63A8\u5BFC\u51FA\u7684\u8D77\u59CB\u7801\u672C\uFF1A\u4E00\u5957\u5148\u9A8C\uFF08\u6F14\u7ECE\u5F0F\uFF09\u4EE3\u7801\u4F9B\u7F16\u7801\u4F7F\u7528\uFF0C\u4E0E\u4ECE\u4F60\u7684\u6570\u636E\u4E2D\u6D8C\u73B0\u7684\u4EE3\u7801\u5E76\u5B58\u3002",
    kitExtractionsLine: "Extractions/ \u2014\u2014 \u6BCF\u4E2A\u7814\u7A76\u95EE\u9898\u5BF9\u5E94\u4E00\u79CD\u63D0\u53D6\u7C7B\u578B\uFF1B\u6BCF\u4E2A Template.md \u4F1A\u9884\u586B Quadro \u663E\u793A\u7684\u63D0\u53D6\u8868\u5355\u3002",
  ...
  logbook: {
    ...
    stepResearch: "\u7814\u7A76",
    stepLibrary: "\u6587\u5E93",
    libraryUpdated: "\u5DF2\u4ECE .bib \u6587\u5E93\u66F4\u65B0 {n} \u6761\u53C2\u8003\u6587\u732E",
    stepAccount: "\u65B9\u6CD5\u8BBA\u8BF4\u660E",
...
var hi = {
  ...
  interview: {
    opening: "\u0906\u0930\u0902\u092D",
    probes: "\u0905\u0928\u0941\u0935\u0930\u094D\u0924\u0940 \u092A\u094D\u0930\u0936\u094D\u0928:",
    sourceSubquestion: "\u0909\u092A-\u092A\u094D\u0930\u0936\u094D\u0928",
    sourceGap: "\u0938\u093E\u0915\u094D\u0937\u094D\u092F-\u0905\u0902\u0924\u0930\u093E\u0932",
    sourceAssumption: "\u092E\u093E\u0928\u094D\u092F\u0924\u093E",
    sourceBelief: "\u0927\u093E\u0930\u0923\u093E",
    sourceOther: "\u0905\u0928\u094D\u092F",
    exportDateLine: "\u0926\u093F\u0928\u093E\u0902\u0915:",
    exportRespondentLine: "\u0909\u0924\u094D\u0924\u0930\u0926\u093E\u0924\u093E:",
    exportClosing: "\u0938\u093E\u0915\u094D\u0937\u093E\u0924\u094D\u0915\u093E\u0930 \u0915\u0947 \u092C\u093E\u0926: \u091F\u094D\u0930\u093E\u0902\u0938\u0915\u094D\u0930\u093F\u092A\u094D\u091F \u0915\u094B markdown \u092B\u093C\u093E\u0907\u0932 \u0915\u0947 \u0930\u0942\u092A \u092E\u0947\u0902 Quadro \u0938\u094D\u091F\u093E\u0930\u094D\u091F\u0930 \u0915\u093F\u091F \u0915\u0947 Data/ \u092B\u093C\u094B\u0932\u094D\u0921\u0930 \u092E\u0947\u0902 \u0930\u0916\u0947\u0902 (\u0938\u0941\u091D\u093E\u0935: Voxtral Transcribe \u0930\u093F\u0915\u0949\u0930\u094D\u0921\u093F\u0902\u0917 \u0915\u094B \u091F\u094D\u0930\u093E\u0902\u0938\u0915\u094D\u0930\u093F\u092A\u094D\u091F \u092E\u0947\u0902 \u092C\u0926\u0932 \u0926\u0947\u0924\u093E \u0939\u0948)\u0964"
  },
  connections: {
    parent: "\u092E\u0942\u0932 \u0938\u0924\u094D\u0930",
    followUps: "\u0905\u0928\u0941\u0935\u0930\u094D\u0924\u0940 \u0938\u0924\u094D\u0930",
    hub: "\u092A\u094D\u0930\u094B\u091C\u0947\u0915\u094D\u091F \u0939\u092C",
    sharedSources: "{n} \u0938\u094D\u0930\u094B\u0924 \u0938\u093E\u091D\u093E \u0915\u0930\u0924\u093E \u0939\u0948",
    more: "\u2026 \u0914\u0930 {n} \u0905\u0927\u093F\u0915"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "\u0917\u0941\u0923\u093E\u0924\u094D\u092E\u0915 \u0935\u093F\u0936\u094D\u0932\u0947\u0937\u0923 (Quadro)",
    qdaSourceLine: "{root} \u0938\u0947 {date} \u0915\u094B \u092A\u0922\u093C\u093E \u0917\u092F\u093E\u0964",
    qdaCodesLine: "\u0915\u094B\u0921\u092C\u0941\u0915: {total} \u0915\u094B\u0921 ({groups} \u0938\u092E\u0942\u0939); {created} \u092C\u0928\u093E\u090F \u0917\u090F, \u092E\u094C\u091C\u0942\u0926\u093E \u0915\u094B\u0921 \u0915\u094B {assigned} \u0906\u0935\u0902\u091F\u0928\u0964",
    qdaSaturationLine: "\u0938\u0902\u0924\u0943\u092A\u094D\u0924\u093F-\u0938\u0902\u0915\u0947\u0924 (\u0915\u094B\u0921): {assigned} \u0906\u0935\u0902\u091F\u0928\u094B\u0902 \u0915\u0947 \u092E\u0941\u0915\u093E\u092C\u0932\u0947 {created} \u0928\u090F (\u0905\u0928\u0941\u092A\u093E\u0924 {ratio})\u0964",
    qdaExtractionsLine: "\u090F\u0915\u094D\u0938\u091F\u094D\u0930\u0948\u0915\u094D\u0936\u0928: {types} \u092A\u094D\u0930\u0915\u093E\u0930; {created} \u092C\u0928\u093E\u090F \u0917\u090F, {added} \u0905\u0928\u0941\u091A\u094D\u091B\u0947\u0926 \u091C\u094B\u0921\u093C\u0947 \u0917\u090F\u0964",
    qdaDataLine: "\u092A\u0922\u093C\u0947 \u0917\u090F \u0915\u0947 \u0930\u0942\u092A \u092E\u0947\u0902 \u091A\u093F\u0939\u094D\u0928\u093F\u0924 \u0921\u0947\u091F\u093E-\u092B\u093C\u093E\u0907\u0932\u0947\u0902: {n}\u0964",
    qdaPeriodLine: "{first} \u0938\u0947 {last} \u0924\u0915 \u0926\u0930\u094D\u091C \u0917\u0924\u093F\u0935\u093F\u0927\u093F\u0964"
  },
  quadro: {
    codebookGroup: "\u0938\u0948\u0926\u094D\u0927\u093E\u0902\u0924\u093F\u0915 \u0932\u0947\u0902\u0938",
    codeDescription: "{why} \u092F\u0939 \u092D\u0935\u093F\u0937\u094D\u092F\u0935\u093E\u0923\u0940 \u0915\u0930\u0947\u0917\u093E: {predicts}",
    codeDescriptionLensOnly: "\u0938\u0948\u0926\u094D\u0927\u093E\u0902\u0924\u093F\u0915 \u0932\u0947\u0902\u0938: {name}\u0964",
    kitReadmeTitle: "Quadro \u0938\u094D\u091F\u093E\u0930\u094D\u091F\u0930 \u0915\u093F\u091F",
    kitReadmeIntro: "Parallax \u0926\u094D\u0935\u093E\u0930\u093E {source} \u0938\u0947 {date} \u0915\u094B \u091C\u0928\u0930\u0947\u091F \u0915\u093F\u092F\u093E \u0917\u092F\u093E\u0964 Data, Codes \u0914\u0930 Extractions \u092B\u093C\u094B\u0932\u094D\u0921\u0930\u094B\u0902 \u0915\u094B \u0905\u092A\u0928\u0947 Quadro-\u0935\u0949\u0932\u094D\u091F \u0915\u0940 root \u092E\u0947\u0902 \u0915\u0949\u092A\u0940 \u0915\u0930\u0947\u0902 (\u092F\u093E \u0909\u0928\u094D\u0939\u0947\u0902 Quadro \u0915\u0940 \u0938\u0947\u091F\u093F\u0902\u0917\u094D\u0938 \u092E\u0947\u0902 \u0915\u0949\u0928\u094D\u092B\u093C\u093F\u0917\u0930 \u0915\u093F\u090F \u0917\u090F \u092B\u093C\u094B\u0932\u094D\u0921\u0930\u094B\u0902 \u092E\u0947\u0902 \u092E\u093F\u0932\u093E \u0926\u0947\u0902)\u0964",
    kitCodesLine: "Codes/ \u2014 \u0905\u092A\u0928\u093E\u090F \u0917\u090F \u0938\u0948\u0926\u094D\u0927\u093E\u0902\u0924\u093F\u0915 \u0932\u0947\u0902\u0938\u094B\u0902 \u0938\u0947 \u0935\u094D\u092F\u0941\u0924\u094D\u092A\u0928\u094D\u0928 \u090F\u0915 \u092A\u094D\u0930\u093E\u0930\u0902\u092D\u093F\u0915 \u0915\u094B\u0921\u092C\u0941\u0915: \u0915\u094B\u0921\u093F\u0902\u0917 \u0915\u0947 \u0932\u093F\u090F \u090F\u0915 \u092A\u0942\u0930\u094D\u0935-\u0928\u093F\u0930\u094D\u0927\u093E\u0930\u093F\u0924 (\u0928\u093F\u0917\u092E\u0928\u093E\u0924\u094D\u092E\u0915) \u0938\u0947\u091F, \u0909\u0928 \u0915\u094B\u0921 \u0915\u0947 \u0938\u093E\u0925-\u0938\u093E\u0925 \u091C\u094B \u0906\u092A\u0915\u0947 \u0921\u0947\u091F\u093E \u0938\u0947 \u0909\u092D\u0930\u0924\u0947 \u0939\u0948\u0902\u0964",
    kitExtractionsLine: "Extractions/ \u2014 \u092A\u094D\u0930\u0924\u093F \u0936\u094B\u0927-\u092A\u094D\u0930\u0936\u094D\u0928 \u090F\u0915 \u090F\u0915\u094D\u0938\u091F\u094D\u0930\u0948\u0915\u094D\u0936\u0928-\u092A\u094D\u0930\u0915\u093E\u0930; \u092A\u094D\u0930\u0924\u094D\u092F\u0947\u0915 Template.md \u0909\u0938 \u090F\u0915\u094D\u0938\u091F\u094D\u0930\u0948\u0915\u094D\u0936\u0928-\u092B\u093C\u0949\u0930\u094D\u092E \u0915\u094B \u092A\u0939\u0932\u0947 \u0938\u0947 \u092D\u0930 \u0926\u0947\u0924\u093E \u0939\u0948 \u091C\u094B Quadro \u0926\u093F\u0916\u093E\u0924\u093E \u0939\u0948\u0964",
  ...
  logbook: {
    ...
    libraryUpdated: ".bib \u0932\u093E\u0907\u092C\u094D\u0930\u0947\u0930\u0940 \u0938\u0947 {n} \u0938\u0902\u0926\u0930\u094D\u092D \u0905\u092A\u0921\u0947\u091F \u0915\u093F\u090F \u0917\u090F",
    stepAccount: "\u0935\u093F\u0935\u0930\u0923",
    ...
    stepArgument: "\u0924\u0930\u094D\u0915",
    argumentAdopted: "\u0924\u0930\u094D\u0915-\u092E\u093E\u0928\u091A\u093F\u0924\u094D\u0930 \u092E\u0947\u0902 {n} \u0924\u0924\u094D\u0935 \u0905\u092A\u0928\u093E\u090F \u0917\u090F",
    stepConnections: "\u0938\u0902\u092C\u0902\u0927",
...
var ar = {
  ...
  interview: {
    opening: "\u0627\u0644\u0627\u0641\u062A\u062A\u0627\u062D",
    probes: "\u0623\u0633\u0626\u0644\u0629 \u0645\u062A\u0627\u0628\u0639\u0629:",
    sourceSubquestion: "\u0633\u0624\u0627\u0644 \u0641\u0631\u0639\u064A",
    sourceGap: "\u0641\u062C\u0648\u0629 \u0641\u064A \u0627\u0644\u0623\u062F\u0644\u0629",
    sourceAssumption: "\u0627\u0641\u062A\u0631\u0627\u0636",
    sourceBelief: "\u0642\u0646\u0627\u0639\u0629",
    sourceOther: "\u0623\u062E\u0631\u0649",
    exportDateLine: "\u0627\u0644\u062A\u0627\u0631\u064A\u062E:",
    exportRespondentLine: "\u0627\u0644\u0645\u0634\u0627\u0631\u0643:",
    exportClosing: "\u0628\u0639\u062F \u0627\u0644\u0645\u0642\u0627\u0628\u0644\u0629: \u0627\u062D\u0641\u0638 \u0627\u0644\u0646\u0635 \u0627\u0644\u0645\u0641\u0631\u0651\u063A \u0643\u0645\u0644\u0641 markdown \u0641\u064A \u0645\u062C\u0644\u062F Data/ \u0636\u0645\u0646 \u062D\u0632\u0645\u0629 \u0628\u062F\u0621 Quadro (\u0646\u0635\u064A\u062D\u0629: \u064A\u062D\u0648\u0651\u0644 Voxtral Transcribe \u0627\u0644\u062A\u0633\u062C\u064A\u0644 \u0625\u0644\u0649 \u0646\u0635 \u0645\u0641\u0631\u0651\u063A)."
  },
  connections: {
    parent: "\u0627\u0644\u062C\u0644\u0633\u0629 \u0627\u0644\u0623\u0635\u0644",
    followUps: "\u062C\u0644\u0633\u0627\u062A \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629",
    hub: "\u0645\u062D\u0648\u0631 \u0627\u0644\u0645\u0634\u0631\u0648\u0639",
    sharedSources: "\u064A\u062A\u0634\u0627\u0631\u0643 {n} \u0645\u0635\u062F\u0631\u064B\u0627",
    more: "\u2026 \u0648{n} \u0623\u062E\u0631\u0649"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "\u0627\u0644\u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0646\u0648\u0639\u064A (Quadro)",
    qdaSourceLine: "\u0642\u064F\u0631\u0626 \u0645\u0646 {root} \u0641\u064A {date}.",
    qdaCodesLine: "\u062F\u0641\u062A\u0631 \u0627\u0644\u062A\u0631\u0645\u064A\u0632: {total} \u0631\u0645\u0632\u064B\u0627 ({groups} \u0645\u062C\u0645\u0648\u0639\u0627\u062A)\u061B \u0623\u064F\u0646\u0634\u0626 {created}\u060C \u0648{assigned} \u0625\u0633\u0646\u0627\u062F\u064B\u0627 \u0625\u0644\u0649 \u0631\u0645\u0648\u0632 \u0642\u0627\u0626\u0645\u0629.",
    qdaSaturationLine: "\u0625\u0634\u0627\u0631\u0629 \u0627\u0644\u062A\u0634\u0628\u0639 (\u0627\u0644\u0631\u0645\u0648\u0632): {created} \u062C\u062F\u064A\u062F\u0629 \u0645\u0642\u0627\u0628\u0644 {assigned} \u0625\u0633\u0646\u0627\u062F\u064B\u0627 (\u0627\u0644\u0646\u0633\u0628\u0629 {ratio}).",
    qdaExtractionsLine: "\u0627\u0644\u0627\u0633\u062A\u062E\u0644\u0627\u0635\u0627\u062A: {types} \u0646\u0648\u0639 (\u0623\u0646\u0648\u0627\u0639)\u061B \u0623\u064F\u0646\u0634\u0626 {created}\u060C \u0648\u0623\u064F\u0636\u064A\u0641\u062A {added} \u0641\u0642\u0631\u0629.",
    qdaDataLine: "\u0645\u0644\u0641\u0627\u062A \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0633\u0648\u0645\u0629 \u0643\u0645\u0642\u0631\u0648\u0621\u0629: {n}.",
    qdaPeriodLine: "\u0646\u0634\u0627\u0637 \u0645\u0633\u062C\u064E\u0651\u0644 \u0645\u0646 {first} \u0625\u0644\u0649 {last}."
  },
  quadro: {
    codebookGroup: "\u0627\u0644\u0639\u062F\u0633\u0627\u062A \u0627\u0644\u0646\u0638\u0631\u064A\u0629",
    codeDescription: "{why} \u0645\u0646 \u0634\u0623\u0646\u0647 \u0623\u0646 \u064A\u062A\u0646\u0628\u0623 \u0628\u0645\u0627 \u064A\u0644\u064A: {predicts}",
    codeDescriptionLensOnly: "\u0627\u0644\u0639\u062F\u0633\u0629 \u0627\u0644\u0646\u0638\u0631\u064A\u0629: {name}.",
    kitReadmeTitle: "\u062D\u0632\u0645\u0629 \u0627\u0646\u0637\u0644\u0627\u0642 Quadro",
    kitReadmeIntro: "\u0623\u064F\u0646\u0634\u0626 \u0628\u0648\u0627\u0633\u0637\u0629 Parallax \u0645\u0646 {source} \u0641\u064A {date}. \u0627\u0646\u0633\u062E \u0627\u0644\u0645\u062C\u0644\u062F\u0627\u062A Data \u0648Codes \u0648Extractions \u0625\u0644\u0649 \u062C\u0630\u0631 \u0642\u0628\u0648 Quadro \u0644\u062F\u064A\u0643 (\u0623\u0648 \u0627\u062F\u0645\u062C\u0647\u0627 \u0641\u064A \u0627\u0644\u0645\u062C\u0644\u062F\u0627\u062A \u0627\u0644\u0645\u0636\u0628\u0648\u0637\u0629 \u0641\u064A \u0625\u0639\u062F\u0627\u062F\u0627\u062A Quadro).",
    kitCodesLine: "Codes/ \u2014 \u062F\u0641\u062A\u0631 \u062A\u0631\u0645\u064A\u0632 \u0623\u0648\u0644\u064A \u0645\u0634\u062A\u0642 \u0645\u0646 \u0627\u0644\u0639\u062F\u0633\u0627\u062A \u0627\u0644\u0646\u0638\u0631\u064A\u0629 \u0627\u0644\u0645\u0639\u062A\u0645\u062F\u0629: \u0645\u062C\u0645\u0648\u0639\u0629 \u0642\u0628\u0644\u064A\u0629 (\u0627\u0633\u062A\u0646\u0628\u0627\u0637\u064A\u0629) \u0644\u0644\u062A\u0631\u0645\u064A\u0632 \u0628\u0647\u0627\u060C \u0625\u0644\u0649 \u062C\u0627\u0646\u0628 \u0627\u0644\u0631\u0645\u0648\u0632 \u0627\u0644\u062A\u064A \u062A\u0646\u0628\u062B\u0642 \u0645\u0646 \u0628\u064A\u0627\u0646\u0627\u062A\u0643.",
    kitExtractionsLine: "Extractions/ \u2014 \u0646\u0648\u0639 \u0627\u0633\u062A\u062E\u0644\u0627\u0635 \u0648\u0627\u062D\u062F \u0644\u0643\u0644 \u0633\u0624\u0627\u0644 \u0628\u062D\u062B\u064A\u061B \u0643\u0644 Template.md \u064A\u0645\u0644\u0623 \u0645\u0633\u0628\u0642\u064B\u0627 \u0646\u0645\u0648\u0630\u062C \u0627\u0644\u0627\u0633\u062A\u062E\u0644\u0627\u0635 \u0627\u0644\u0630\u064A \u064A\u0639\u0631\u0636\u0647 Quadro.",
  ...
  logbook: {
    ...
    stepResearch: "\u0627\u0644\u0628\u062D\u062B",
    stepLibrary: "\u0627\u0644\u0645\u0643\u062A\u0628\u0629",
    libraryUpdated: "\u062A\u0645 \u062A\u062D\u062F\u064A\u062B {n} \u0645\u0646 \u0627\u0644\u0645\u0631\u0627\u062C\u0639 \u0645\u0646 \u0645\u0643\u062A\u0628\u0629 \u200E.bib",
    stepAccount: "\u0627\u0644\u062A\u0648\u062B\u064A\u0642",
    ...
    stepArgument: "\u0627\u0644\u062D\u062C\u0629",
    argumentAdopted: "\u0627\u0639\u062A\u064F\u0645\u062F {n} \u0639\u0646\u0635\u0631\u064B\u0627 \u0641\u064A \u062E\u0631\u064A\u0637\u0629 \u0627\u0644\u062D\u062C\u0629",
    stepConnections: "\u0627\u0644\u0631\u0648\u0627\u0628\u0637",
...
var ja = {
  ...
  interview: {
    opening: "\u5C0E\u5165",
    probes: "\u6DF1\u6398\u308A\u8CEA\u554F\uFF1A",
    sourceSubquestion: "\u30B5\u30D6\u30AF\u30A8\u30B9\u30C1\u30E7\u30F3",
    sourceGap: "\u30A8\u30D3\u30C7\u30F3\u30B9\u306E\u7A7A\u767D",
    sourceAssumption: "\u524D\u63D0",
    sourceBelief: "\u4FE1\u5FF5",
    sourceOther: "\u305D\u306E\u4ED6",
    exportDateLine: "\u65E5\u4ED8\uFF1A",
    exportRespondentLine: "\u56DE\u7B54\u8005\uFF1A",
    exportClosing: "\u30A4\u30F3\u30BF\u30D3\u30E5\u30FC\u5F8C\uFF1A\u6587\u5B57\u8D77\u3053\u3057\u3092 markdown \u30D5\u30A1\u30A4\u30EB\u3068\u3057\u3066 Quadro \u30B9\u30BF\u30FC\u30BF\u30FC\u30AD\u30C3\u30C8\u306E Data/ \u30D5\u30A9\u30EB\u30C0\u30FC\u306B\u4FDD\u5B58\u3057\u3066\u304F\u3060\u3055\u3044\uFF08\u30D2\u30F3\u30C8\uFF1AVoxtral Transcribe \u304C\u9332\u97F3\u3092\u6587\u5B57\u8D77\u3053\u3057\u306B\u5909\u63DB\u3057\u307E\u3059\uFF09\u3002"
  },
  connections: {
    parent: "\u89AA\u30BB\u30C3\u30B7\u30E7\u30F3",
    followUps: "\u30D5\u30A9\u30ED\u30FC\u30A2\u30C3\u30D7\u30BB\u30C3\u30B7\u30E7\u30F3",
    hub: "\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30CF\u30D6",
    sharedSources: "{n} \u4EF6\u306E\u51FA\u5178\u3092\u5171\u6709",
    more: "\u2026 \u307B\u304B {n} \u4EF6"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "\u8CEA\u7684\u5206\u6790\uFF08Quadro\uFF09",
    qdaSourceLine: "{date}\u306B{root}\u304B\u3089\u8AAD\u307F\u53D6\u3063\u305F\u3002",
    qdaCodesLine: "\u30B3\u30FC\u30C9\u30D6\u30C3\u30AF: {total}\u4EF6\u306E\u30B3\u30FC\u30C9\uFF08{groups}\u30B0\u30EB\u30FC\u30D7\uFF09\u3002\u65B0\u898F\u4F5C\u6210{created}\u4EF6\u3001\u65E2\u5B58\u30B3\u30FC\u30C9\u3078\u306E\u5272\u308A\u5F53\u3066{assigned}\u4EF6\u3002",
    qdaSaturationLine: "\u98FD\u548C\u306E\u30B7\u30B0\u30CA\u30EB\uFF08\u30B3\u30FC\u30C9\uFF09: \u5272\u308A\u5F53\u3066{assigned}\u4EF6\u306B\u5BFE\u3057\u3066\u65B0\u898F{created}\u4EF6\uFF08\u6BD4\u7387 {ratio}\uFF09\u3002",
    qdaExtractionsLine: "\u62BD\u51FA: {types}\u7A2E\u985E\u3002{created}\u4EF6\u3092\u4F5C\u6210\u3001{added}\u6BB5\u843D\u3092\u8FFD\u52A0\u3002",
    qdaDataLine: "\u65E2\u8AAD\u3068\u3057\u3066\u30DE\u30FC\u30AF\u3055\u308C\u305F\u30C7\u30FC\u30BF\u30D5\u30A1\u30A4\u30EB: {n}\u4EF6\u3002",
    qdaPeriodLine: "\u8A18\u9332\u3055\u308C\u305F\u6D3B\u52D5: {first}\u304B\u3089{last}\u307E\u3067\u3002"
  },
  quadro: {
    codebookGroup: "\u7406\u8AD6\u30EC\u30F3\u30BA",
    codeDescription: "{why} \u3053\u306E\u30EC\u30F3\u30BA\u304C\u4E88\u6E2C\u3059\u308B\u3053\u3068: {predicts}",
    codeDescriptionLensOnly: "\u7406\u8AD6\u30EC\u30F3\u30BA: {name}\u3002",
    kitReadmeTitle: "Quadro \u30B9\u30BF\u30FC\u30BF\u30FC\u30AD\u30C3\u30C8",
    kitReadmeIntro: "{date}\u306B Parallax \u306B\u3088\u3063\u3066 {source} \u304B\u3089\u751F\u6210\u3055\u308C\u305F\u3002\u30D5\u30A9\u30EB\u30C0 Data\u3001Codes\u3001Extractions \u3092 Quadro \u306E\u4FDD\u7BA1\u5EAB\uFF08vault\uFF09\u306E\u30EB\u30FC\u30C8\u306B\u30B3\u30D4\u30FC\u3059\u308B\uFF08\u307E\u305F\u306F Quadro \u306E\u8A2D\u5B9A\u3067\u69CB\u6210\u3055\u308C\u3066\u3044\u308B\u30D5\u30A9\u30EB\u30C0\u306B\u7D71\u5408\u3059\u308B\uFF09\u3002",
    kitCodesLine: "Codes/ \u2014 \u63A1\u7528\u3057\u305F\u7406\u8AD6\u30EC\u30F3\u30BA\u304B\u3089\u5C0E\u51FA\u3057\u305F\u958B\u59CB\u7528\u30B3\u30FC\u30C9\u30D6\u30C3\u30AF: \u30C7\u30FC\u30BF\u304B\u3089\u7ACB\u3061\u73FE\u308C\u308B\u30B3\u30FC\u30C9\u3068\u4E26\u3093\u3067\u7528\u3044\u308B\u3001\u30A2\u30D7\u30EA\u30AA\u30EA\uFF08\u6F14\u7E79\u7684\uFF09\u306A\u30B3\u30FC\u30C7\u30A3\u30F3\u30B0\u7528\u30BB\u30C3\u30C8\u3002",
    kitExtractionsLine: "Extractions/ \u2014 \u30EA\u30B5\u30FC\u30C1\u30AF\u30A8\u30B9\u30C1\u30E7\u30F3\u3054\u3068\u306B1\u3064\u306E\u62BD\u51FA\u30BF\u30A4\u30D7\u3002\u5404 Template.md \u304C\u3001Quadro \u306B\u8868\u793A\u3055\u308C\u308B\u62BD\u51FA\u30D5\u30A9\u30FC\u30E0\u3092\u3042\u3089\u304B\u3058\u3081\u57CB\u3081\u308B\u3002",
  ...
  logbook: {
    ...
    stepResearch: "\u8ABF\u67FB",
    stepLibrary: "\u30E9\u30A4\u30D6\u30E9\u30EA",
    libraryUpdated: ".bib\u30E9\u30A4\u30D6\u30E9\u30EA\u304B\u3089{n}\u4EF6\u306E\u53C2\u8003\u6587\u732E\u3092\u66F4\u65B0\u3057\u307E\u3057\u305F",
    stepAccount: "\u8AAC\u660E",
    ...
    stepArgument: "\u8AD6\u8A3C",
    argumentAdopted: "\u8AD6\u8A3C\u30DE\u30C3\u30D7\u306B {n} \u4EF6\u306E\u8981\u7D20\u3092\u63A1\u7528",
    stepConnections: "\u3064\u306A\u304C\u308A",
...
var ko = {
  ...
  interview: {
    opening: "\uB3C4\uC785",
    probes: "\uCD94\uAC00 \uC9C8\uBB38:",
    sourceSubquestion: "\uD558\uC704 \uC9C8\uBB38",
    sourceGap: "\uC99D\uAC70 \uACF5\uBC31",
    sourceAssumption: "\uAC00\uC815",
    sourceBelief: "\uC2E0\uB150",
    sourceOther: "\uAE30\uD0C0",
    exportDateLine: "\uB0A0\uC9DC:",
    exportRespondentLine: "\uC751\uB2F5\uC790:",
    exportClosing: "\uC778\uD130\uBDF0 \uD6C4: \uC804\uC0AC\uBCF8\uC744 markdown \uD30C\uC77C\uB85C Quadro \uC2A4\uD0C0\uD130 \uD0A4\uD2B8\uC758 Data/ \uD3F4\uB354\uC5D0 \uC800\uC7A5\uD558\uC138\uC694 (\uD301: Voxtral Transcribe\uAC00 \uB179\uC74C\uC744 \uC804\uC0AC\uBCF8\uC73C\uB85C \uBCC0\uD658\uD569\uB2C8\uB2E4)."
  },
  connections: {
    parent: "\uC0C1\uC704 \uC138\uC158",
    followUps: "\uD6C4\uC18D \uC138\uC158",
    hub: "\uD504\uB85C\uC81D\uD2B8 \uD5C8\uBE0C",
    sharedSources: "{n}\uAC1C \uCD9C\uCC98 \uACF5\uC720",
    more: "\u2026 \uC678 {n}\uAC1C"
  },
  beliefs: {
  ...
  account: {
    ...
    qdaHeading: "\uC9C8\uC801 \uBD84\uC11D(Quadro)",
    qdaSourceLine: "{date}\uC5D0 {root}\uC5D0\uC11C \uC77D\uC5C8\uC2B5\uB2C8\uB2E4.",
    qdaCodesLine: "\uCF54\uB4DC\uBD81: \uCF54\uB4DC {total}\uAC1C({groups}\uAC1C \uADF8\uB8F9); {created}\uAC1C \uC0DD\uC131, \uAE30\uC874 \uCF54\uB4DC\uC5D0 \uB300\uD55C \uD560\uB2F9 {assigned}\uAC74.",
    qdaSaturationLine: "\uD3EC\uD654 \uC2E0\uD638(\uCF54\uB4DC): \uD560\uB2F9 {assigned}\uAC74 \uB300\uBE44 \uC2E0\uADDC {created}\uAC1C(\uBE44\uC728 {ratio}).",
    qdaExtractionsLine: "\uCD94\uCD9C: \uC720\uD615 {types}\uAC1C; {created}\uAC1C \uC0DD\uC131, \uBB38\uB2E8 {added}\uAC1C \uCD94\uAC00.",
    qdaDataLine: "\uC77D\uC74C\uC73C\uB85C \uD45C\uC2DC\uB41C \uB370\uC774\uD130 \uD30C\uC77C: {n}\uAC1C.",
    qdaPeriodLine: "{first}\uBD80\uD130 {last}\uAE4C\uC9C0\uC758 \uD65C\uB3D9\uC774 \uAE30\uB85D\uB418\uC5C8\uC2B5\uB2C8\uB2E4."
  },
  quadro: {
    codebookGroup: "\uC774\uB860\uC801 \uB80C\uC988",
    codeDescription: "{why} \uC774 \uB80C\uC988\uAC00 \uC608\uCE21\uD558\uB294 \uBC14: {predicts}",
    codeDescriptionLensOnly: "\uC774\uB860\uC801 \uB80C\uC988: {name}.",
    kitReadmeTitle: "Quadro \uC2A4\uD0C0\uD130 \uD0A4\uD2B8",
    kitReadmeIntro: "{date}\uC5D0 Parallax\uAC00 {source}\uC5D0\uC11C \uC0DD\uC131\uD588\uC2B5\uB2C8\uB2E4. Data, Codes, Extractions \uD3F4\uB354\uB97C Quadro \uBCF4\uAD00\uD568(vault)\uC758 \uB8E8\uD2B8\uC5D0 \uBCF5\uC0AC\uD558\uC2ED\uC2DC\uC624(\uB610\uB294 Quadro \uC124\uC815\uC5D0 \uAD6C\uC131\uB41C \uD3F4\uB354\uC5D0 \uBCD1\uD569\uD558\uC2ED\uC2DC\uC624).",
    kitCodesLine: "Codes/ \u2014 \uCC44\uD0DD\uD55C \uC774\uB860\uC801 \uB80C\uC988\uC5D0\uC11C \uB3C4\uCD9C\uD55C \uC2DC\uC791 \uCF54\uB4DC\uBD81: \uB370\uC774\uD130\uC5D0\uC11C \uB5A0\uC624\uB974\uB294 \uCF54\uB4DC\uC640 \uB098\uB780\uD788 \uC0AC\uC6A9\uD560 \uC120\uD5D8\uC801(\uC5F0\uC5ED\uC801) \uCF54\uB529 \uC138\uD2B8\uC785\uB2C8\uB2E4.",
    kitExtractionsLine: "Extractions/ \u2014 \uC5F0\uAD6C \uC9C8\uBB38\uB9C8\uB2E4 \uD558\uB098\uC758 \uCD94\uCD9C \uC720\uD615\uC774\uBA70, \uAC01 Template.md\uB294 Quadro\uAC00 \uD45C\uC2DC\uD558\uB294 \uCD94\uCD9C \uC591\uC2DD\uC744 \uBBF8\uB9AC \uCC44\uC6C1\uB2C8\uB2E4.",
  ...
  logbook: {
    ...
    stepResearch: "\uC5F0\uAD6C",
    stepLibrary: "\uB77C\uC774\uBE0C\uB7EC\uB9AC",
    libraryUpdated: ".bib \uB77C\uC774\uBE0C\uB7EC\uB9AC\uC5D0\uC11C \uCC38\uACE0\uBB38\uD5CC {n}\uAC74 \uC5C5\uB370\uC774\uD2B8\uB428",
    stepAccount: "\uC124\uBA85",
    ...
    stepArgument: "\uB17C\uC99D",
    argumentAdopted: "\uB17C\uC99D \uC9C0\uB3C4\uC5D0 {n}\uAC1C \uC694\uC18C \uCC44\uD0DD",
    stepConnections: "\uC5F0\uACB0",
...
function paperToRecord(paper, key) {
  ...
  return {
    ...
    citekey: (_a = paper.library) == null ? void 0 : _a.citekey,
    origin: paper.library ? "library" : void 0,
    occurrences: []
  };
}
function enrichRecord(record, paper) {
  ...
  if ((_a = paper.library) == null ? void 0 : _a.citekey) {
    record.citekey = paper.library.citekey;
...
function sanitizeRecord(raw) {
  ...
  return {
    ...
    citekey: typeof r.citekey === "string" && r.citekey.length > 0 ? r.citekey : void 0,
    origin: r.origin === "library" ? "library" : void 0,
    occurrences
  };
}
...
var ResultsModal = class extends import_obsidian5.Modal {
  constructor(app, result, settings, onSubmit, opts = {}) {
    ...
    this.synthesisLanded = !!opts.synthesisLanded;
    this.onSubmit = onSubmit;
...
var QUADRO_CONVENTIONS = {
  ...
  /** progress.json lives in the analysis folder: `<analysis>/progress.json`. */
  progressFileName: "progress.json",
  /** The front-matter key Quadro writes on code files (create-new-code-file.ts). */
...
function sanitizeQuadroName(name) {
  return name.replace(/\.md$/, "").replace(/[:#^?!"*<>|[\]\\]/g, "-").replace(/^\.|\/\./g, "").replace(/^\/+|\/+$/g, "").replace(/\//g, "-").trim();
}
function codeDescriptionFor(lens) {
  var _a, _b;
  const why = ((_a = lens.why) != null ? _a : "").trim();
  const predicts = ((_b = lens.predicts) != null ? _b : "").trim();
  let desc;
  if (why && predicts) desc = fmt(t().quadro.codeDescription, { why, predicts });
  else if (why || predicts) desc = why || predicts;
  else desc = fmt(t().quadro.codeDescriptionLensOnly, { name: lens.name });
  return desc.replace(/\s+/g, " ").replace(/"/g, "'").trim();
}
function renderCodebook(lenses) {
  const group = sanitizeQuadroName(t().quadro.codebookGroup);
  const seen = /* @__PURE__ */ new Set();
  const files = [];
  for (const lens of lenses) {
    let name = sanitizeQuadroName(lens.name);
    if (!name) continue;
    while (seen.has(name.toLowerCase())) name = `${name} 2`;
    seen.add(name.toLowerCase());
    const content = ["---", `${QUADRO_CONVENTIONS.codeDescriptionKey}: "${codeDescriptionFor(lens)}"`, "---", "", ""].join(
      "\n"
    );
    files.push({ path: `${QUADRO_CONVENTIONS.defaultCodesFolder}/${group}/${name}.md`, content });
  }
  return files;
}
function extractionTypeFolder(question, index) {
  const words = sanitizeQuadroName(question).split(/\s+/).slice(0, 6).join(" ");
  return `question-${index + 1}${words ? ` ${words}` : ""}`.slice(0, 80).trim();
}
...
function renderStarterKit(lenses, questions, provenance) {
  ...
  const readme = [
    `# ${q.kitReadmeTitle}`,
    "",
    fmt(q.kitReadmeIntro, { source: provenance.source, date: provenance.date }),
    "",
    `- ${q.kitDataLine}`,
    `- ${q.kitCodesLine}`,
    `- ${q.kitExtractionsLine}`,
    "",
    q.kitFieldsNote,
    ""
  ].join("\n");
...
` });
  ...
  questions.forEach((question, i) => {
    ...
    if (!trimmed) return;
    let folder = extractionTypeFolder(trimmed, i);
    while (seenTypes.has(folder.toLowerCase())) folder = `${folder} 2`;
    seenTypes.add(folder.toLowerCase());
    files.push({
      path: `${QUADRO_CONVENTIONS.defaultExtractionsFolder}/${folder}/Template.md`,
      content: renderExtractionTemplate(trimmed)
    });
  });
  return files;
}
var METHOD_LABELS = new Map(
  ARTIFACT_LANGUAGES.flatMap((lang) => {
    const a = ARTIFACT_STRINGS[lang].agenda;
    return [
      [a.methodQualitative.toLowerCase(), "qualitative"],
      [a.methodQuantitative.toLowerCase(), "quantitative"],
      [a.methodMixed.toLowerCase(), "mixed"]
    ];
  })
);
function parseAgendaQuestions(agendaSection) {
  const labels = new Set(ARTIFACT_LANGUAGES.map((lang) => ARTIFACT_STRINGS[lang].agenda.newQuestions.toLowerCase()));
  const questions = [];
  let inBlock = false;
  for (const line of agendaSection.split("\n")) {
    ...
    if (bullet) {
      const aside = bullet[1].match(/^(.*\S)\s+\*\((.+)\)\*$/);
      const method = aside ? METHOD_LABELS.get(aside[2].split("\u2014")[0].trim().toLowerCase()) : void 0;
      questions.push(method && aside ? { question: aside[1], method } : { question: bullet[1] });
    } else if (line.trim() !== "") inBlock = false;
  }
  return questions;
}
function subQuestionsFromStrategy(queries, seeds) {
  const seedSet = new Set(seeds.map((s) => s.trim()));
  return queries.map((q) => q.trim()).filter((q) => q && !seedSet.has(q));
}
function parseQuadroFolders(dataJson) {
  var _a, _b, _c;
  const folders = {
    codes: QUADRO_CONVENTIONS.defaultCodesFolder,
    extractions: QUADRO_CONVENTIONS.defaultExtractionsFolder,
    analysis: QUADRO_CONVENTIONS.defaultAnalysisFolder
  };
  if (!dataJson) return folders;
  try {
    const parsed = JSON.parse(dataJson);
    if (typeof parsed !== "object" || parsed === null) return folders;
    const settings = parsed;
    if (typeof ((_a = settings.coding) == null ? void 0 : _a.folder) === "string" && settings.coding.folder.trim()) folders.codes = settings.coding.folder;
    if (typeof ((_b = settings.extraction) == null ? void 0 : _b.folder) === "string" && settings.extraction.folder.trim())
      folders.extractions = settings.extraction.folder;
    if (typeof ((_c = settings.analysis) == null ? void 0 : _c.folder) === "string" && settings.analysis.folder.trim()) folders.analysis = settings.analysis.folder;
  } catch (e) {
  }
  return folders;
}
function parseQuadroProgress(progressJson) {
  let parsed;
  try {
    parsed = JSON.parse(progressJson);
  } catch (e) {
    return null;
  }
  ...
  const groups = QUADRO_CONVENTIONS.progressGroups;
  const count = (day, group, action) => {
    const g = day[group];
  ...
  for (const [date, day] of Object.entries(parsed)) {
    ...
    if (stats.firstDate === null || date < stats.firstDate) stats.firstDate = date;
    if (stats.lastDate === null || date > stats.lastDate) stats.lastDate = date;
    const d = day;
    stats.codesCreated += count(d, groups.code, "new");
    stats.codeAssignments += count(d, groups.code, "assign");
    stats.extractionsCreated += count(d, groups.extraction, "new");
    stats.paragraphsAdded += count(d, groups.extraction, "added paragraph");
    stats.dataFilesRead += count(d, groups.data, "read");
  }
  return stats;
}
function codebookStatsFromPaths(codesFolder, markdownPaths) {
  const prefix = `${codesFolder.replace(/\/+$/, "")}/`;
  const groups = /* @__PURE__ */ new Set();
  let total = 0;
  for (const path of markdownPaths) {
    if (!path.startsWith(prefix)) continue;
    const rel = path.slice(prefix.length);
    if (rel === "Template.md") continue;
    total++;
    const slash = rel.indexOf("/");
    groups.add(slash === -1 ? "" : rel.slice(0, slash));
  }
  return { total, groups: groups.size };
}
function renderQdaSection(input) {
  ...
  if (input.codebook !== null || input.progress !== null) {
    lines.push(
      `- ${fmt(a.qdaCodesLine, {
        ...
        created: String((_f = (_e = input.progress) == null ? void 0 : _e.codesCreated) != null ? _f : 0),
        assigned: String((_h = (_g = input.progress) == null ? void 0 : _g.codeAssignments) != null ? _h : 0)
      })}`
    );
  }
...
function methodFitLabel(method) {
  const a = t().agenda;
  return method === "qualitative" ? a.methodQualitative : method === "quantitative" ? a.methodQuantitative : a.methodMixed;
}
...
var SYSTEM = [
  ...
  '"new_questions":[{"question":"a sharp NEW research question that arises FROM the synthesis","method":"qualitative|quantitative|mixed \u2014 which methodological tradition fits this question","method_rationale":"ONE short line on why that method fits"}],',
...
function parseAgendaNewQuestions(raw) {
  if (!Array.isArray(raw)) return [];
  const seen = /* @__PURE__ */ new Set();
  const out = [];
  ...
  for (const entry of raw) {
    ...
    if (typeof entry === "string") {
      ...
      if (question) {
        q = { question };
        const method = str(e.method).toLowerCase();
        if (METHOD_FITS.includes(method)) {
          q.method = method;
          const rationale = str(e.method_rationale);
          if (rationale) q.methodRationale = rationale;
        }
      }
    }
    if (!q) continue;
    ...
    seen.add(key);
    out.push(q);
    if (out.length >= MAX_AGENDA_ITEMS) break;
  }
  return out;
}
...
function parseResearchAgenda(raw, log) {
  ...
  if (!p) return null;
  const agenda = {
    gaps: cleanList(p.gaps, MAX_AGENDA_ITEMS),
    limitations: cleanList(p.limitations, MAX_AGENDA_ITEMS),
    newQuestions: parseAgendaNewQuestions(p.new_questions),
    designs: parseDesigns(p.designs),
    data: cleanList(p.data, MAX_AGENDA_ITEMS)
  };
...
function agendaAdoptionRecord(agenda, choice) {
  ...
  return {
    newQuestions: agenda.newQuestions.map((q) => q.question),
    ...choice.startSessionWith ? { chosenQuestion: choice.startSessionWith } : {},
    ...methodFits.length > 0 ? { methodFits } : {}
  };
}

// src/quadro-kit-modal.ts
var QuadroKitModal = class extends import_obsidian7.Modal {
  constructor(app, questions, onChoice) {
    super(app);
    this.resolved = false;
    this.questions = questions;
    this.selected = questions.map((q) => q.method !== "quantitative");
    this.onChoice = onChoice;
  }
  onOpen() {
    const { contentEl } = this;
    applyModalChrome(this);
    contentEl.createEl("h2", { text: "Quadro starter kit" });
    contentEl.createEl("p", {
      text: "Every ticked question becomes an extraction template in the kit. Questions with a quantitative method fit are unticked by default \u2014 Quadro's extraction-based coding suits qualitative questions. You decide.",
      cls: "consensus-handoff-hint"
    });
    this.questions.forEach((q, i) => {
      new import_obsidian7.Setting(contentEl).setName(q.question).setDesc(q.method ? methodFitLabel(q.method) : "").addToggle((toggle) => toggle.setValue(this.selected[i]).onChange((v) => this.selected[i] = v));
    });
    new import_obsidian7.Setting(contentEl).addButton(
      (b) => b.setButtonText("Export starter kit").setCta().onClick(() => {
        this.resolve(this.questions.filter((_, i) => this.selected[i]).map((q) => q.question));
        this.close();
      })
    );
  }
...
// src/record-hygiene.ts
function repointPath(notePath, oldPath, newPath) {
  if (notePath === oldPath) return newPath;
  if (notePath.startsWith(`${oldPath}/`)) return newPath + notePath.slice(oldPath.length);
  return notePath;
}
function renamePathsInGraphStore(store, oldPath, newPath) {
  let changed = 0;
  for (const record of [...store.sessions, ...store.artefacts]) {
    const next = repointPath(record.note, oldPath, newPath);
    if (next !== record.note) {
      record.note = next;
      changed++;
    }
...
function renamePathsInRegister(register, oldPath, newPath) {
  let changed = 0;
  for (const citation of register.citations) {
    for (const occurrence of citation.occurrences) {
      const next = repointPath(occurrence.note, oldPath, newPath);
      if (next !== occurrence.note) {
        occurrence.note = next;
        changed++;
      }
    }
  }
...
function scanOrphans(store, register, existingPaths) {
  var _a;
  const groups = /* @__PURE__ */ new Map();
  const group = (folder) => {
    let g = groups.get(folder);
    if (!g) {
      g = { folder, graphNotes: [], refs: [] };
      groups.set(folder, g);
    }
    return g;
  };
  const deadGraphNotes = /* @__PURE__ */ new Set();
  for (const record of [...store.sessions, ...store.artefacts]) {
    if (!existingPaths.has(record.note)) deadGraphNotes.add(record.note);
  }
  for (const note of [...deadGraphNotes].sort()) group(parentOf(note)).graphNotes.push(note);
  for (const citation of register.citations) {
    const dead = citation.occurrences.filter((o) => !existingPaths.has(o.note));
    if (dead.length === 0) continue;
    const liveCount = citation.occurrences.length - dead.length;
    const byFolder = /* @__PURE__ */ new Map();
    for (const o of dead) {
      const folder = parentOf(o.note);
      byFolder.set(folder, [...(_a = byFolder.get(folder)) != null ? _a : [], o.note]);
    }
    for (const [folder, deadNotes] of byFolder) {
      group(folder).refs.push({ key: citation.key, title: citation.title, deadNotes, liveCount });
    }
  }
  return [...groups.values()].sort((a, b) => a.folder.localeCompare(b.folder));
}
function applyPrune(store, register, selection) {
  const result = { removedGraphRecords: 0, removedOccurrences: 0, removedReferences: 0 };
  const keepNote = (note) => !selection.graphNotes.has(note);
  const sessionsBefore = store.sessions.length;
  const artefactsBefore = store.artefacts.length;
  store.sessions = store.sessions.filter((r) => keepNote(r.note));
  store.artefacts = store.artefacts.filter((r) => keepNote(r.note));
  result.removedGraphRecords = sessionsBefore - store.sessions.length + (artefactsBefore - store.artefacts.length);
  register.citations = register.citations.filter((citation) => {
    const ticked = selection.refOccurrences.get(citation.key);
    if (!ticked || ticked.size === 0) return true;
    const before = citation.occurrences.length;
    citation.occurrences = citation.occurrences.filter((o) => !ticked.has(o.note));
    result.removedOccurrences += before - citation.occurrences.length;
    if (citation.occurrences.length === 0) {
...
// src/record-hygiene-modal.ts
var import_obsidian8 = require("obsidian");
var RecordHygieneModal = class extends import_obsidian8.Modal {
  constructor(app, groups, onConfirm) {
    super(app);
  ...
  onOpen() {
    applyModalChrome(this);
    const { contentEl } = this;
    contentEl.createEl("h3", { text: "Clean up records for missing notes" });
    contentEl.createEl("p", {
      text: "These records point at notes that no longer exist. Nothing is selected by default and nothing is written until you confirm. References that are still used in existing notes always stay \u2014 only their dead entries are removed.",
      cls: "setting-item-description"
    });
    for (const group of this.groups) {
      const groupToggles = [];
      new import_obsidian8.Setting(contentEl).setName(group.folder || "(vault root)").setDesc(`${group.graphNotes.length + group.refs.length} orphaned item(s) in this missing folder`).setHeading().addToggle(
        (toggle) => toggle.setValue(false).onChange((value) => {
          for (const set of groupToggles) if (value) set();
          if (!value) {
            for (const note of group.graphNotes) this.noteTicks.set(note, false);
            for (const ref of group.refs) this.refTicks.set(this.refKey(ref.key, group.folder), false);
          }
          this.display();
        })
      );
      for (const note of group.graphNotes) {
        const name = note.slice(note.lastIndexOf("/") + 1).replace(/\.md$/, "");
        new import_obsidian8.Setting(contentEl).setName(`Session records \u2014 ${name}`).setDesc("Search strategy, adoptions and findings recorded for this deleted note.").addToggle((toggle) => {
          var _a;
          toggle.setValue((_a = this.noteTicks.get(note)) != null ? _a : false).onChange((v) => this.noteTicks.set(note, v));
          groupToggles.push(() => this.noteTicks.set(note, true));
        });
      }
      for (const ref of group.refs) {
        const key = this.refKey(ref.key, group.folder);
        const stays = ref.liveCount > 0;
        new import_obsidian8.Setting(contentEl).setName(`Reference \u2014 ${ref.title}`).setDesc(
          `${ref.deadNotes.length} dead entr${ref.deadNotes.length === 1 ? "y" : "ies"} here. ` + (stays ? `Still used in ${ref.liveCount} existing note(s) \u2014 the reference itself stays.` : "No remaining uses \u2014 removing this deletes the reference from the register.")
        ).addToggle((toggle) => {
          var _a;
          toggle.setValue((_a = this.refTicks.get(key)) != null ? _a : false).onChange((v) => this.refTicks.set(key, v));
          groupToggles.push(() => this.refTicks.set(key, true));
        });
      }
    }
    new import_obsidian8.Setting(contentEl).addButton(
      (b) => b.setButtonText("Remove selected").setCta().onClick(() => {
        this.close();
        this.onConfirm(this.selection());
      })
    ).addButton((b) => b.setButtonText("Cancel").onClick(() => this.close()));
  }
  /** Re-render in place (group toggle changed many item states). */
  display() {
    this.contentEl.empty();
    this.onOpen();
  }
  ...
  selection() {
    var _a;
    const graphNotes = /* @__PURE__ */ new Set();
    for (const [note, ticked] of this.noteTicks) if (ticked) graphNotes.add(note);
    const refOccurrences = /* @__PURE__ */ new Map();
    for (const group of this.groups) {
      for (const ref of group.refs) {
        if (!this.refTicks.get(this.refKey(ref.key, group.folder))) continue;
        const set = (_a = refOccurrences.get(ref.key)) != null ? _a : /* @__PURE__ */ new Set();
        for (const note of ref.deadNotes) set.add(note);
        refOccurrences.set(ref.key, set);
      }
    }
    return { graphNotes, refOccurrences };
  }
  onClose() {
    this.contentEl.empty();
  }
...
var MAX_PROBES = 3;
function sourceKindLabel(labels, kind) {
  const map = {
    subquestion: labels.sourceSubquestion,
    gap: labels.sourceGap,
    assumption: labels.sourceAssumption,
    belief: labels.sourceBelief,
    other: labels.sourceOther
  };
  return map[kind];
}
function cleanQuestionId(v) {
  return typeof v === "string" ? v.replace(/[^A-Za-z0-9_-]/g, "") : "";
}
function isSourceKind(v) {
  return v === "subquestion" || v === "gap" || v === "assumption" || v === "belief" || v === "other";
}
function parseSource(raw) {
  if (!raw || typeof raw !== "object") return { kind: "other" };
  const e = raw;
  const kind = isSourceKind(e.kind) ? e.kind : "other";
...
function parseInterviewGuide(raw, log) {
  const p = parseJsonObject(raw, "interview", log);
  if (!p) return null;
  const questions = [];
  const seenIds = /* @__PURE__ */ new Set();
  for (const entry of Array.isArray(p.questions) ? p.questions : []) {
    if (questions.length >= MAX_INTERVIEW_QUESTIONS) break;
    if (!entry || typeof entry !== "object") continue;
    const e = entry;
    const id = cleanQuestionId(e.id);
    const text = typeof e.text === "string" ? e.text.trim() : "";
    if (!id || !text) continue;
    const key = id.toLowerCase();
    if (seenIds.has(key)) continue;
    seenIds.add(key);
    questions.push({ id, text, source: parseSource(e.source), probes: parseProbes(e.probes) });
  }
  if (questions.length === 0) {
    log == null ? void 0 : log("empty result \u2014 interview: no valid questions");
    return null;
  }
  const opening = typeof p.opening === "string" ? p.opening.trim() : "";
  return { ...opening ? { opening } : {}, questions, adoptedAt: "" };
}
function filterInterviewGuide(guide, adoptedIds) {
  return { ...guide, questions: guide.questions.filter((q) => adoptedIds.has(q.id)) };
}
function provenanceLabel(q, labels) {
  const kind = sourceKindLabel(labels, q.source.kind);
...
var SYSTEM2 = [
  "You are a careful research-interview designer turning a researcher's open thinking into a topic guide \u2014 you design the conversation, you do not conduct or analyse it.",
  "From the session content, propose open, non-leading interview QUESTIONS that could close what the researcher does not know yet.",
  "Every question MUST carry its provenance: which sub-question, evidence gap, attacked assumption or belief from the provided context blocks it is meant to illuminate.",
  `Propose at most ${MAX_INTERVIEW_QUESTIONS} questions, each with at most ${MAX_PROBES} short follow-up probes.`,
  'Return strict JSON: {"opening":"one short opening note (context/purpose of the interview)",',
  '"questions":[{"id":"Q1","text":"one open interview question","source":{"kind":"subquestion|gap|assumption|belief|other","ref":"short quote or node id from the context block it traces to"},"probes":["short follow-up"]}]}.',
  'Ids: "Q1","Q2",\u2026. "source.kind" MUST name the kind of context block the question traces to; use "other" only when none fits, and keep "ref" short.',
  "Do NOT answer the questions, do NOT search literature, do NOT invent findings, sources or citations, and write NO consent script \u2014 that is the researcher's own responsibility.",
  "Write the opening, questions and probes in the SAME language as the session's question. Respond with strict JSON only."
].join(" ");
...
async function proposeInterviewGuide(context, chat, log) {
  let raw;
  try {
    raw = await chat(
      [{ role: "user", content: buildInterviewPrompt(context) }],
      // Provenance faithfulness matters more than creative phrasing — keep the temperature low.
      { json: true, temperature: 0.2 }
    );
  } catch (e) {
    log == null ? void 0 : log("chat failure \u2014 interview", String(e));
    return null;
  }
  return parseInterviewGuide(raw, log);
}
...
function sanitizeArgumentStructure(raw) {
  if (!raw || typeof raw !== "object") return void 0;
  const obj = raw;
  const nodes = [];
  const seenIds = /* @__PURE__ */ new Set();
  for (const entry of Array.isArray(obj.nodes) ? obj.nodes : []) {
    if (!entry || typeof entry !== "object") continue;
    const e = entry;
  ...
  const edges = [];
  for (const entry of Array.isArray(obj.edges) ? obj.edges : []) {
    if (!entry || typeof entry !== "object") continue;
    const e = entry;
...
function sanitizeInterviewGuide(raw) {
  ...
  for (const entry of Array.isArray(obj.questions) ? obj.questions : []) {
    ...
    seenIds.add(id);
    const rawSource = e.source && typeof e.source === "object" ? e.source : {};
    const kinds = ["subquestion", "gap", "assumption", "belief", "other"];
    const kind = kinds.includes(rawSource.kind) ? rawSource.kind : "other";
    const ref = typeof rawSource.ref === "string" ? rawSource.ref.trim() : "";
    const source = { kind, ...ref ? { ref } : {} };
    const probes = [];
    for (const p of Array.isArray(e.probes) ? e.probes : []) {
      if (probes.length >= MAX_PROBES) break;
      const s = typeof p === "string" ? p.trim() : "";
      if (s) probes.push(s);
    }
    questions.push({ id, text, source, probes });
  }
  ...
  return {
    ...opening ? { opening } : {},
    questions,
    adoptedAt: typeof obj.adoptedAt === "string" ? obj.adoptedAt : ""
  };
}
...
function assembleMethodologyAccount(session, body, sourceLink, qdaBody) {
  const parts = [];
...
function libraryItemText(entry) {
  ...
  return [entry.citekey, p.authors.join(" "), year, p.title].filter((s) => s.length > 0).join(" \u2014 ");
}
var LibraryPickerModal = class extends import_obsidian9.FuzzySuggestModal {
  constructor(app, entries, onChoose) {
    super(app);
    this.entries = entries;
    this.onChoose = onChoose;
    this.setPlaceholder("Search your library (citekey, author, year, title)\u2026");
  }
  getItems() {
    return this.entries;
  }
  getItemText(entry) {
    return libraryItemText(entry);
  }
  onChooseItem(entry) {
    this.onChoose(entry);
  }
...
async function runResearch(rawQuestion, settings, http, provider, filters = {}, log = createLogger(false), opts = {}) {
    ...
    return async (messages, copts) => {
      ...
      try {
        return await provider.chat(
          ...
          { log, label: step, reasoningEffort: resolveStepReasoning(settings, step), onRetry: opts.onLlmRetry }
        );
      } catch (e) {
  ...
  const embed = async (texts) => {
    try {
      return await provider.embed(texts, { log, label: "embed", onRetry: opts.onLlmRetry });
    } catch (e) {
...
var SessionStore = class {
  ...
  async createSessionNote(question, folderPath, project, opts = {}) {
    ...
    let path = (0, import_obsidian11.normalizePath)(`${folder}${slug2}${t().project.sessionFileSuffix}.md`);
    for (let n = 2; this.deps.vault.getAbstractFileByPath(path); n++) {
      path = (0, import_obsidian11.normalizePath)(`${folder}${slug2}${t().project.sessionFileSuffix} (${n}).md`);
    }
...
var _WorkbenchView = class _WorkbenchView extends import_obsidian12.ItemView {
  ...
  renderResume(root) {
    ...
    new import_obsidian12.Setting(box).setName("Resume last research").setDesc("Re-run rerank + synthesis on the cached search \u2014 no re-fetching.").addButton((b) => {
  ...
  renderOnboarding(root) {
    ...
    new import_obsidian12.Setting(box).addButton((b) => {
  ...
  async renderProjectPanel(root, file, session) {
    ...
    new import_obsidian12.Setting(wrap).addButton((b) => {
    ...
    if (hypotheses.length > 0) {
      ...
      for (const h of hypotheses) {
        ...
        const setting = new import_obsidian12.Setting(list).setName(h.text).setDesc(`${kindLabel} \xB7 from "${h.sourceTitle}"`);
        setting.addButton((b) => {
  ...
  renderGapGroup(root, label, items, withFollowUp) {
    ...
    for (const item of items) {
      if (withFollowUp && item.followUp) {
        ...
        const setting = new import_obsidian12.Setting(wrap).setName(item.text).setDesc(`From "${this.noteTitle(item.note)}"`);
        setting.addButton((b) => {
          b.setButtonText("Research this");
...
function parseExploration(raw, log) {
  ...
  if (!p) return null;
  const result = {
    assumptions: cleanList2(p.assumptions, MAX_EXPLORATION_ITEMS),
    counterAssumptions: cleanList2(p.counter_assumptions, MAX_EXPLORATION_ITEMS),
    questionVariants: cleanList2(p.question_variants, MAX_EXPLORATION_ITEMS),
    lenses: cleanList2(p.lenses, MAX_EXPLORATION_ITEMS),
    definitions: cleanList2(p.definitions, MAX_EXPLORATION_ITEMS),
    searchTermSeeds: cleanList2(p.search_term_seeds, MAX_SEARCH_TERM_SEEDS),
...
function parseTheory(raw, log) {
  ...
  const result = {
    ...
    sameMechanism: cleanList3(p.same_mechanism, MAX_THEORY_ITEMS),
    absent: cleanList3(p.absent, MAX_THEORY_ITEMS),
    competing: cleanList3(p.competing, MAX_THEORY_ITEMS),
    crossDomain: cleanList3(p.cross_domain, MAX_THEORY_ITEMS),
...
function isNodeKind(v) {
  return v === "claim" || v === "assumption";
}
function isEdgeKind(v) {
  return v === "supports" || v === "attacks";
}
function parseArgumentStructure(raw, log) {
  const p = parseJsonObject(raw, "argument", log);
  if (!p) return null;
  const str = (v) => typeof v === "string" ? v.trim() : "";
  const nodes = [];
  const seenIds = /* @__PURE__ */ new Set();
  const perKind = { claim: 0, assumption: 0 };
  const caps = { claim: MAX_ARGUMENT_CLAIMS, assumption: MAX_ARGUMENT_ASSUMPTIONS };
  for (const entry of Array.isArray(p.nodes) ? p.nodes : []) {
    if (!entry || typeof entry !== "object") continue;
    const e = entry;
    const id = cleanNodeId(e.id);
    const text = str(e.text);
    if (!id || !text || !isNodeKind(e.kind)) continue;
    const key = id.toLowerCase();
    if (seenIds.has(key)) continue;
  ...
  for (const entry of Array.isArray(p.edges) ? p.edges : []) {
    if (edges.length >= MAX_ARGUMENT_EDGES) break;
    if (!entry || typeof entry !== "object") continue;
    const e = entry;
    const from = cleanNodeId(e.from);
    const to = cleanNodeId(e.to);
    if (!isEdgeKind(e.kind) || !knownIds.has(from) || !knownIds.has(to) || from === to) continue;
...
function buildArgumentPrompt(context) {
  return `${SYSTEM8}

Session content:
${context}`;
}
async function proposeArgumentStructure(context, chat, log) {
  let raw;
  try {
    raw = await chat(
      [{ role: "user", content: buildArgumentPrompt(context) }],
      // Structure extraction wants faithfulness over creativity — keep the temperature low.
      { json: true, temperature: 0.2 }
    );
  } catch (e) {
    log == null ? void 0 : log("chat failure \u2014 argument", String(e));
    return null;
  }
...
function parseCanvas(raw) {
  ...
  const nodes = (Array.isArray(p.nodes) ? p.nodes : []).filter(hasId);
  const edges = (Array.isArray(p.edges) ? p.edges : []).filter(hasId).filter((e) => typeof e.fromNode === "string" && typeof e.toNode === "string");
  return { nodes, edges };
}
...
function sharedSourceCounts(register, notePath) {
  var _a;
  const counts = /* @__PURE__ */ new Map();
  for (const c of register.citations) {
    if (!c.occurrences.some((o) => o.note === notePath)) continue;
    const others = new Set(c.occurrences.map((o) => o.note).filter((n) => n !== notePath));
    for (const other of others) counts.set(other, ((_a = counts.get(other)) != null ? _a : 0) + 1);
  }
  return counts;
}
    ...
    if (this.agenda.newQuestions.length > 0) {
      ...
      this.agenda.newQuestions.forEach((q, i) => {
        ...
        new import_obsidian22.Setting(contentEl).setName(q.question).setDesc((_a = q.methodRationale) != null ? _a : "").addDropdown((d) => {
          ...
          d.setValue((_a2 = q.method) != null ? _a2 : "").onChange((v) => {
            q.method = v || void 0;
            q.methodRationale = q.method === original[i].method ? original[i].rationale : void 0;
          });
        });
      });
...
var ParallaxPlugin = class extends import_obsidian23.Plugin {
  constructor() {
    super(...arguments);
    /**
     * Last-read state of the owner's `.bib` library (AU_E100_S2), null until the
     * first refresh. In-memory only — the `.bib` file is the source of truth.
     */
    this.library = null;
    /**
...
`);
   ...
   * Public: called from {@link registerCommands}.
   */
  // ── Quadro interop (AU_E99_S1/S2/S3) — file-level hand-off, no runtime dependency ──
  /** Write kit files under `root` (paths relative to it), creating nested folders first. */
  ...
  /**
   * The active session's adopted lenses + agenda questions, or null without a session. Primary
   * source: the E89 structured adoption records. Fallback (owner test jul 2026): the note
   * itself — the agenda section's question bullets (the "insert at cursor" modal path writes
   * no record) and the front-matter lens names — because the note is the human-canonical
   * carrier and must win over an absent machine projection.
   */
  async quadroSeeds() {
    var _a, _b, _c, _d, _e, _f, _g;
    const active = this.activeSession();
    ...
    const record = artefactRecordForNote(store, active.file.path);
    const adoptions = record == null ? void 0 : record.adoptions;
    let lenses = (_b = (_a = adoptions == null ? void 0 : adoptions.theory) == null ? void 0 : _a.chosenLenses) != null ? _b : [];
    const fitFor = new Map(((_d = (_c = adoptions == null ? void 0 : adoptions.agenda) == null ? void 0 : _c.methodFits) != null ? _d : []).map((f) => [f.question, f.method]));
    const withFit = (question) => {
      const method = fitFor.get(question);
      return method ? { question, method } : { question };
    };
    const questions = ((_f = (_e = adoptions == null ? void 0 : adoptions.agenda) == null ? void 0 : _e.newQuestions) != null ? _f : []).map(withFit);
    const chosen = (_g = adoptions == null ? void 0 : adoptions.agenda) == null ? void 0 : _g.chosenQuestion;
    if (chosen && !questions.some((q) => q.question === chosen)) questions.unshift(withFit(chosen));
    if (questions.length === 0) {
      const body = await this.app.vault.cachedRead(active.file);
      const section = parseAgendaQuestions(extractSection(body, "agenda"));
      questions.push(...section.length > 0 ? section : parseAgendaQuestions(body));
    }
    if (questions.length === 0 && (record == null ? void 0 : record.searchStrategy)) {
      questions.push(
        ...subQuestionsFromStrategy(record.searchStrategy.queries, record.searchStrategy.seeds).map((question) => ({ question }))
      );
    }
    if (lenses.length === 0 && active.session.lenses.length > 0) {
      lenses = active.session.lenses.map((name) => ({ name }));
    }
    return { file: active.file, lenses, questions };
  }
  /**
   * AU_E99_S1 — export the adopted theoretical lenses as a Quadro starting codebook
   * (`Codes/<group>/<lens>.md`, `code description` front-matter). Copy-out into the export
   * folder; Parallax works fully without Quadro. Public: called from {@link registerCommands}.
   */
  ...
  /**
   * AU_E99_S2 — export the full Quadro starter kit: kit README + Data/README (Voxtral as the
   * intake route) + the S1 codebook + one extraction Template.md per agenda question (reserved
   * Quadro keys deliberately absent). Public: called from {@link registerCommands}.
   */
  async exportQuadroStarterKit() {
    ...
    if (seeds.questions.length === 0) {
      await this.writeStarterKit(seeds.file, seeds.lenses, []);
      return;
    }
  ...
  /** Write the starter kit for the given questions (AU_E99_S2; selection split off in AU_E109_S2). */
  async writeStarterKit(file, lenses, questions) {
    try {
      const safeName = safeFileName(file.basename).trim() || t().project.exportFolderFallback;
      const root = `Exports/${safeName}/quadro-starter-kit`;
      const date = (/* @__PURE__ */ new Date()).toISOString().slice(0, 10);
      const files = renderStarterKit(lenses, questions, {
  ...
  async onVaultRename(file, oldPath) {
    ...
    try {
      ...
      const graph = parseGraphStore(await vaultStore.read(graphPath));
      if (renamePathsInGraphStore(graph, oldPath, file.path) > 0) {
        await vaultStore.write(graphPath, serializeGraphStore(graph));
      }
      const register = await this.vaultAdapters.loadRegisterGuarded(vaultStore, this.settings.registerPath);
      if (renamePathsInRegister(register, oldPath, file.path) > 0) {
  ...
  /**
   * AU_E106_S2 — the explicit cleanup command: scan both stores for records pointing at notes
   * that no longer exist, show the selection modal (grouped per missing folder, everything
   * unticked), and apply only what the user confirmed. Deliberately NOT hooked on delete
   * events: a delete may be a sync glitch or an undo. Public: called from {@link registerCommands}.
   */
  async runRecordCleanup() {
    try {
      const vaultStore = this.vaultAdapters.vaultStore();
      const graphPath = this.vaultAdapters.graphStorePath();
      const graph = parseGraphStore(await vaultStore.read(graphPath));
      ...
      notifyError("Cleaning up records", e);
    }
  }
  /**
   ...
   */
  async newSessionNearActiveNote(question) {
    var _a;
    const file = this.activeNoteFile();
    const folder = (file == null ? void 0 : file.parent) && file.parent.path !== "/" ? file.parent.path : "";
    const fm = file ? (_a = this.app.metadataCache.getFileCache(file)) == null ? void 0 : _a.frontmatter : void 0;
    const project = file ? resolveProject(file.path, fm) : void 0;
    return this.createSessionNote(question, folder, project, { silent: true });
  }
